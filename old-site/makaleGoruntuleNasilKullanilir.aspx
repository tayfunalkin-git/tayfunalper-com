<%@ Language="C#" MasterPageFile="~/talper.master" AutoEventWireup="true" Debug="true" CodeFile="makaleGoruntuleNasilKullanilir.aspx.cs" Inherits="makaleGoruntule" %>
                                  ...
                                  <div class="col-lg-12">
                                   <div class="row" style="margin-top:10px;">
                                     ...
                                     <div class="col-lg-12" style="float:right;text-align:right;">
                                         ...
                                         <a href='http://www.annebabaoluyoruz.biz' target="_blank" class='btn width-190 full-width-sm' style="background-color:#000000;color:#fff;">Siteye Git</a>
