<%@ Page Language="C#" AutoEventWireup="true" CodeFile="hasta_kimlik_guncelleme_bilgi.aspx.cs" Inherits="ivfyonetici_hasta_modulu_hasta_kimlik_guncelleme_bilgi" %>
...
<body>
    ...
    <div>
        <table border="0" cellpadding="0" cellspacing="0" style="border-right: #d3d3d3 1px solid;
            ...
            <tr>
                <td style="height: 30px; background-color: #f5f5f5; text-align: center">
        ...
        <table cellpadding="0" cellspacing="0" style="width: 100%">
            <tr>
                <td style="font-size: 11px; width: 195px; color: black; font-family: verdana; height: 41px;
                    text-decoration: none">
                    &nbsp;<span style="font-family: Arial"><strong>Hastayý Kaydeden :<br />
                    &nbsp;Kayýt Tarihi : </strong></span>
                </td>
                <td style="font-size: 11px; width: 300px; color: black; font-family: verdana; height: 41px;
                    text-decoration: none">
                    <asp:Label ID="ekleyen" runat="server" Font-Bold="True" ForeColor="MidnightBlue" Font-Names="Arial" Font-Size="11px"></asp:Label>
                    <br />
                    <asp:Label ID="eklenmetarihi" runat="server" Font-Bold="True" Font-Names="Arial" Font-Size="11px"></asp:Label></td>
                <td style="font-size: 11px; color: black; font-family: verdana; height: 41px; text-decoration: none">
                </td>
            </tr>
            <tr>
                <td colspan="2" style="font-size: 11px; color: black; font-family: verdana; text-decoration: none">
                    <asp:GridView ID="list" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                        ...
                        <RowStyle BackColor="#F7F6F3" BorderColor="Black" BorderStyle="Solid" BorderWidth="1px"
                            Font-Names="Arial" ForeColor="#333333" Font-Size="11px" />
            ...
            <tr>
                <td colspan="2" style="font-size: 11px; color: black; font-family: verdana; text-align: center;
                    text-decoration: none">
                    <span style="color: #0000ff; text-decoration: underline; font-family: Arial;"><a href="javascript:window.close();">KAPAT</a></span></td>
                <td style="font-size: 11px; color: black; font-family: verdana; text-decoration: none">
                </td>
            </tr>
        </table>
