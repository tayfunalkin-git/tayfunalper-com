<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ana_renk_guncelleme_bilgi.aspx.cs" Inherits="ivfyonetici_hasta_modulu_renk_guncelleme_bilgi" %>
        ...
        <table border="0" cellpadding="0" cellspacing="0" style="border-right: #d3d3d3 1px solid;
            ...
            <tr>
                <td style="height: 34px; background-color: #f5f5f5; text-align: center">
                    <asp:Label ID="alan" runat="server" Font-Bold="True" ForeColor="MidnightBlue" Font-Names="Arial" Font-Size="12px"></asp:Label><br />
                ...
                <td colspan="2" style="font-size: 11px; color: black; font-family: verdana; text-decoration: none">
                    <asp:GridView ID="list" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="guncelleme_tarihi" HeaderText="G&#252;ncellemeTarihi" />
                            <asp:BoundField DataField="renk" HeaderText="Rengin Tanýmladýðý Alan" />
                        </Columns>
