<%@ Page Language="C#" AutoEventWireup="true" CodeFile="takipli_siklus_guncelleme_bilgi.aspx.cs" Inherits="ivfyonetici_hasta_modulu_hasta_kimlik_guncelleme_bilgi" %>
...
<body>
    ...
    <div>
        <table border="0" cellpadding="0" cellspacing="0" style="border-right: #d3d3d3 1px solid;
            ...
            <tr>
                <td style="height: 30px; background-color: #f5f5f5; text-align: center">
                    <asp:Label ID="alan" runat="server" Font-Bold="True" Font-Names="Arial" Font-Size="12px"
                        ForeColor="MidnightBlue"></asp:Label><br />
        ...
        <table cellpadding="0" cellspacing="0" style="width: 100%">
            <tr>
                <td style="font-size: 11px; width: 195px; color: black; font-family: verdana; height: 9px;
                    text-decoration: none">
                    &nbsp;</td>
                <td style="font-size: 11px; width: 300px; color: black; font-family: verdana; height: 9px;
                    text-decoration: none">
                    &nbsp;<br />
                    </td>
                <td style="font-size: 11px; color: black; font-family: verdana; height: 9px; text-decoration: none">
                </td>
            </tr>
            <tr>
