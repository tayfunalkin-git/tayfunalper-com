...
public partial class ivfyonetici_hasta_modulu_hasta_kimlik_guncelleme_bilgi : System.Web.UI.Page
{
    ...
    void bilgi_yukle3()
    {
        ...
        try
        {
            ...
            Page.Title = "..:: " + mp_dt.Rows[0]["uye_adi"].ToString() + " " + mp_dt.Rows[0]["uye_soyadi"].ToString() + "  &  Takipli Siklus Güncelleme Detaylarý ::..   ";
        }
    ...
    void bilgi_yukle()
    {
        ...
        try
        {
            ...
            MySqlConnection mp_connection = mp_class.connect_ivf(0301009184);
            MySqlDataAdapter mp_da = new MySqlDataAdapter("Select * from takipli_siklus_guncellemeleri where siklus_id='" +Request.QueryString["siklus_id"].ToString() + "' order by date(tarih) desc", mp_connection);
            DataTable mp_dt = new DataTable();
            mp_da.Fill(mp_dt);
            ...
            sonuc.Text = " Toplam Takipli Siklus Güncelleme Sayýsý : " + mp_dt.Rows.Count;
        }
    ...
    void bilgi_yukle2()
    {
        ...
        try
        {
            ...
            alan.Text = dt5.Rows[0]["siklus_ay"].ToString() + " - " + dt5.Rows[0]["siklus_yil"].ToString() + " | " + "Takipli Siklus Güncellemeleri";
