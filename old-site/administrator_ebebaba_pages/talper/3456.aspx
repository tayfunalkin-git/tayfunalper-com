<%@ Page Language="C#" AutoEventWireup="true" Debug="true" CodeFile="3456.aspx.cs" Inherits="ivfyonetici_talper" %>
                               ...
                               <tr>
                                   <td style="width: 197px; height: 24px;" valign="middle">
                                       &nbsp; <asp:Label ID="page_label" runat="server" Font-Bold="True" Font-Names="Arial"
                                                    Font-Size="11px" Text="Gelir - Gider Durumu (IVF)" style="font-size: 12px"></asp:Label></td>
                                        ...
                                        <tr valign="top">
                                            ...
                                            <td style="font-size: 11px; font-family: arial; " valign="top">
                                                <asp:DropDownList ID="kayitTuru" runat="server" SkinID="drop">
                                                    ...
                                                    <asp:ListItem Value="1">Tüp Bebek</asp:ListItem>
                                                    <asp:ListItem Value="2">Tüp Bebek Dışı Muayene</asp:ListItem>
