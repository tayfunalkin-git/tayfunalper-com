<%@ Page Title="" Language="C#" MasterPageFile="~/administrator_ebebaba_pages/Ebebaba_Master_New.master" AutoEventWireup="true" CodeFile="0000176.aspx.cs" Inherits="mainAdminPagesHdn_0000073" %>
...
vAlign=middle> &nbsp;<asp:Label id="Label14" runat="server" Font-Size="11px" Font-Names="Tahoma" Font-Bold="True" Text="Kayıtlı Ekip Üyeleri"></asp:Label></TD><TD 
style="HEIGHT: 24px; TEXT-ALIGN: right" vAlign=middle>  &nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;</TD></TR></TABLE></TD></TR></TABLE>
      ...
      <div class="form-group">  
        ...
        <asp:DropDownList ID="turList" runat="server" CssClass="form-control" Width="198px">
                ...
                <td style="width: 383px" class="modal-sm">
                    &nbsp;
                    <br />
&nbsp;
        <asp:Button ID="Button3" runat="server" CssClass="btn_1" Text="LİSTELE" OnClick="Button3_Click1" ValidationGroup="tip" />
                </td>
            </tr>
        </table>
