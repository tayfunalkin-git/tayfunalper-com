...
public partial class mainAdminPagesHdn_0000073 : System.Web.UI.Page
{
    ...
    private void mesajver(string p)
    {
        if (p == "G")
        {
            ...
            sonuc.Text = "Ekip üyesi bilgisi başarıyla güncellendi.";
        ...
        else if (p == "Y")
        {
            ...
            panel_sonuc.Visible = true;
            sonuc.Text = "Ekip üyesi başarıyla eklendi.";
            sonuc.ForeColor = System.Drawing.Color.Green;
    ...
    private void turYukle()
    {
        ...
        turList.DataTextField = dt6.Columns["Adi"].ToString();
    ...
    protected void ust_Command(object sender, CommandEventArgs e)
    {
        if (e.CommandName.ToString() != "1")
        {
            ...
            try
            {
                ...
                MySqlConnection connect_word = noc.connect_ebebaba(0301009184);
                MySqlCommand mp_cmd2 = new MySqlCommand("update ekipiceriktablosu set sira = sira + 1 where sira=" + degisecek_sira + " and kategori=" + Label1.Text + "", connect_word);
                ...
                MySqlCommand mp_cmd = new MySqlCommand("update ekipiceriktablosu set sira = " + degisecek_sira + "  where ID=" + e.CommandArgument.ToString() + "", connect_word);
    ...
    protected void ImageButton4_Command(object sender, CommandEventArgs e)
    {
        try
        {
            ...
            MySqlConnection connect_word = noc.connect_ebebaba(0301009184);
            MySqlDataAdapter da = new MySqlDataAdapter("select max(sira) from ekipiceriktablosu where kategori=" + Label1.Text + "", connect_word);
    ...
    protected void sil_Command(object sender, CommandEventArgs e)
    {
        ...
        MySqlCommand mp_cmd2 = new MySqlCommand("update ekipiceriktablosu set sira = sira - 1 where sira > " + e.CommandName.ToString() + " and kategori=" + Label1.Text + "", connect_word);
        ...
        MySqlCommand mp_cmd = new MySqlCommand("delete from ekipiceriktablosu where ID=" + e.CommandArgument.ToString() + "", connect_word);
        ...
        if (eks == 1)
        {
            listeYukle();
            panel_sonuc.Visible = true;
            sonuc.Text = "Ekip üyesi başarıyla silindi.";
            sonuc.ForeColor = System.Drawing.Color.Green;
        ...
        {
            panel_sonuc.Visible = true;
            sonuc.Text = "Ekip üyesi silme işlemi başarısız!";
    ...
    protected void duzenle_Command(object sender, CommandEventArgs e)
    {
        ...
        Response.Redirect("0000181.aspx?ID=" + e.CommandArgument.ToString());
    ...
    protected void Button3_Click1(object sender, EventArgs e)
    {
        ...
        {
            Label1.Text = "";
            Label2.Text = "Lütfen pozisyon seçiniz";
            list.Visible = false;
    ...
    private void listeYukle()
    {
        try
        {
            list.Visible = true;
            MySqlConnection connect_word = noc.connect_ebebaba(0301009184);
            MySqlDataAdapter mp_da = new MySqlDataAdapter("Select * from ekipiceriktablosu where kategori=" + Label1.Text + " order by sira asc", connect_word);
            DataTable mp_dt = new DataTable();
            mp_da.Fill(mp_dt);
            ...
            Label2.Text ="Seçilen pozisyondaki toplam üye sayısı : " +  mp_dt.Rows.Count.ToString();
            ...
            foreach (GridViewRow str in list.Rows)
            {
                ...
                resim.ImageUrl = "~/uploadImages/" + mp_dt.Rows[i]["kapakResmi"].ToString() + "_450.jpg";
    ...
    protected void goruntu_Command(object sender, CommandEventArgs e)
    {
        ...
        MySqlCommand mp_cmd2 = new MySqlCommand("update ekipiceriktablosu set yayin='" + yayin + "' where ID=" + e.CommandArgument.ToString() + "", connect_word);
