<%@ Page Title="" Language="C#" MasterPageFile="~/administrator_ebebaba_pages/Ebebaba_Master_New.master" EnableEventValidation="false" ValidateRequest="false" AutoEventWireup="true" CodeFile="0000185.aspx.cs" Inherits="mainAdminPagesHdn_0000073" %>
...
vAlign=middle> &nbsp;<asp:Label id="Label14" runat="server" Font-Size="11px" Font-Names="Tahoma" Font-Bold="True" Text="6.Bölüm (Boş)"></asp:Label></TD><TD 
style="HEIGHT: 24px; TEXT-ALIGN: right" vAlign=middle>  &nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;</TD></TR></TABLE></TD></TR></TABLE>
    ...
    <p>
        ...
        <asp:TextBox ID="txtSatir2" runat="server" Width="500px" CssClass="form-control" Height="169px" TextMode="MultiLine"></asp:TextBox>
                                            ...
                                            <p>
                                                <span style="color: #0000CC">Düğme Metni :<asp:TextBox ID="txtSatir3" runat="server" Width="500px" CssClass="form-control"></asp:TextBox>
        </span>
    </p>
                                            <p>
                                                <span style="color: #0000CC">Düğme Linki :
       ...
       &nbsp;<asp:TextBox ID="txtSatir4" runat="server" Width="500px" CssClass="form-control"></asp:TextBox>
                                            ...
                                            <p>
                                                ...
                                                <asp:CheckBox ID="txtSatir6" runat="server" />
    </p>
    <hr />
    ...
    <div id="secilenKapakResmi" runat="server">
                                            ...
                                            <p>
                                                <span style="color: #0000CC">Resim Yeri: </span>
    </p>
                                            <p>
