...
public partial class mainAdminPagesHdn_0000073 : System.Web.UI.Page
{
    ...
    protected void Button3_Click(object sender, EventArgs e)
    {
        ...
        MySqlDataAdapter da2 = new MySqlDataAdapter("Select * from kategorilistekip where Adi='" + kategoriAdi.Text + "'", mp_connection);
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            sonuc.Text = "Bu isimde daha önce kaydedilmiş kategori bulundu. Lütfen kontrol ediniz..";
        ...
        else
        {
            ...
            MySqlDataAdapter da = new MySqlDataAdapter("select max(sira) from kategorilistekip", mp_connection);
            ...
            MySqlCommand mp_cmd = new MySqlCommand("insert into kategorilistekip(Adi,sira,goruntu,kisaAd) values ('" + kategoriAdi.Text + "'," + sirano + ",'+',?1)", mp_connection);
            ...
            if (eks == 1)
            {
                ...
                panel_sonuc.Visible = true;
                sonuc.Text = "Yeni pozisyon adı başarıyla kaydedildi.";
            ...
            {
                panel_sonuc.Visible = true;
                sonuc.Text = "Pozisyon Kayıt İşlemi Başarısız ! Lütfen Tekrar Deneyiniz.";
                sonuc.ForeColor = System.Drawing.Color.Red;
    ...
    private void tipleriYukle()
    {
        ...
        {
            MySqlConnection mp_connection = noc.connect_ebebaba(0301009184);
            MySqlDataAdapter mp_da = new MySqlDataAdapter("Select * from kategorilistekip order by sira asc", mp_connection);
            DataTable mp_dt = new DataTable();
            mp_da.Fill(mp_dt);
            ...
            foreach (GridViewRow str in list.Rows)
            {
                ...
                if (mp_dt.Rows[i]["ID"].ToString() == "14" || mp_dt.Rows[i]["ID"].ToString() == "15")
                {
    ...
    protected void ust_Command(object sender, CommandEventArgs e)
    {
        if (e.CommandName.ToString() != "1")
        {
            ...
            try
            {
                ...
                MySqlConnection mp_connection = noc.connect_ebebaba(0301009184);
                MySqlCommand mp_cmd2 = new MySqlCommand("update kategorilistekip set sira = sira + 1 where sira=" + degisecek_sira + "", mp_connection);
                ...
                MySqlCommand mp_cmd = new MySqlCommand("update kategorilistekip set sira = " + degisecek_sira + "  where ID=" + e.CommandArgument.ToString() + "", mp_connection);
    ...
    protected void sil_Command(object sender, CommandEventArgs e)
    {
        ...
        //    {
                MySqlCommand mp_cmd2 = new MySqlCommand("update kategorilistekip set sira = sira - 1 where sira > " + e.CommandName.ToString() + "", mp_connection);
        ...
        MySqlCommand mp_cmd = new MySqlCommand("delete from kategorilistekip where ID=" + e.CommandArgument.ToString() + "", mp_connection);
        ...
        if (eks == 1)
        {
            ...
            panel_sonuc.Visible = true;
            sonuc.Text = "Pozisyon adı başarıyla silindi.";
            sonuc.ForeColor = System.Drawing.Color.Green;
        ...
        {
            panel_sonuc.Visible = true;
            sonuc.Text = "Pozisyon silme işlemi başarısız.";
            sonuc.ForeColor = System.Drawing.Color.Red;
    ...
    protected void kaydet_Command(object sender, CommandEventArgs e)
    {
        ...
        string yeniAd = ((TextBox)list.Rows[int.Parse(e.CommandName.ToString())].FindControl("txtTip")).Text;
        ...
        if (yeniAd != "")
        {
            ...
            MySqlConnection mp_connection = noc.connect_ebebaba(0301009184);
            MySqlDataAdapter da = new MySqlDataAdapter("select * from kategorilistekip where not ID=" + e.CommandArgument + " and Adi='" + yeniAd + "'", mp_connection);
            DataTable mp_dt = new DataTable();
            da.Fill(mp_dt);
            ...
            {
                panel_sonuc.Visible = true;
                sonuc.Text = "Bu isimde kayıtlı başka bir pozisyon adı bulunmaktadır!";
                sonuc.ForeColor = System.Drawing.Color.Red;
            ...
            else
            {
                ...
                MySqlCommand mp_cmd2 = new MySqlCommand("update kategorilistekip set Adi=?1,kisaAd=?2 where ID=?3", mp_connection);
                ...
                if (eks2 == 1)
                {
                    ...
                    panel_sonuc.Visible = true;
                    sonuc.Text = "Pozisyon adı başarıyla güncellendi.";
                    sonuc.ForeColor = System.Drawing.Color.Green;
                ...
                {
                    panel_sonuc.Visible = true;
                    sonuc.Text = "Pozisyon adı değiştirme işlemi başarısız!";
                    sonuc.ForeColor = System.Drawing.Color.Red;
