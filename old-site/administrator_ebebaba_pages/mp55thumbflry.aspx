<%@ Page Language="C#" AutoEventWireup="true" CodeFile="mp55thumbflry.aspx.cs" Inherits="ivfyonetici_mp55thumb"  %>
        ...
        <table cellpadding="2" class="auto-style1">
            ...
            <tr>
                ...
                <td style="font-family: arial, Helvetica, sans-serif; font-size: 12px">
                    <asp:Button ID="Button1" runat="server" Text="Kaydet &amp; Güncelle" Width="146px" BackColor="#FFFF99" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" Height="30px" OnClick="Button1_Click" />
                </td>
            </tr>
            <tr>
