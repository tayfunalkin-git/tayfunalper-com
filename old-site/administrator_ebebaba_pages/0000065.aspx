<%@ Page Language="C#" MasterPageFile="~/administrator_ebebaba_pages/Ebebaba_Master_New.master"  CodeFile="0000065.aspx.cs" Inherits="administrator_ebebaba_pages_0000065" Theme="SkinFile" EnableEventValidation="false" %>
...
style="WIDTH: 289px; HEIGHT: 24px" vAlign=middle> &nbsp;
    <asp:Label id="Label14" runat="server" Font-Size="11px" Font-Names="Arial" Font-Bold="True" 
                              Text="Giden e-Demokrasi Mesajlarý"></asp:Label> 
                                        ...
                                        <tr>
                                            <td style="font-size: 11px; color: gray; font-family: verdana; height: 23px" colspan="7">
                                                                <asp:GridView ID="gelenmesajlar" runat="server" AutoGenerateColumns="False" BorderColor="White"
                                                                    ...
                                                                    <RowStyle Height="20px" Font-Names="Arial" Font-Size="11px" ForeColor="Black" />
