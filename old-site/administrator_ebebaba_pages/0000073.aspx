<%@ Page Title="" Language="C#" MasterPageFile="~/administrator_ebebaba_pages/Ebebaba_Master_New.master" EnableEventValidation="false" ValidateRequest="false" AutoEventWireup="true" CodeFile="0000073.aspx.cs" Inherits="mainAdminPagesHdn_0000073" %>
...
vAlign=middle> &nbsp;<asp:Label id="Label14" runat="server" Font-Size="11px" Font-Names="Tahoma" Font-Bold="True" Text="Yeni Yazı Ekle"></asp:Label></TD><TD 
style="HEIGHT: 24px; TEXT-ALIGN: right" vAlign=middle>  &nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;</TD></TR></TABLE></TD></TR></TABLE>
               <asp:Panel ID="panel_sonuc" runat="server" Width="100%" HorizontalAlign="Center">
                   <br />
                               <asp:Label ID="sonuc" runat="server" Font-Bold="True" Font-Names="Tahoma" Font-Size="11px" ForeColor="Black"></asp:Label>
                   <br />
                   <br />
               </asp:Panel>
               </td>
    ...
    <p>
        ...
        <asp:TextBox ID="txtIcerik" runat="server" CssClass="tuncay" Width="100%" Height="420px" TextMode="MultiLine"></asp:TextBox>
        </span>
    </p>
    <p>
        <span style="color: #0000CC">
    ...
    <div id="secilenKapakResmi" runat="server">
                                            ...
                                            <span style="color: #0000CC">Bunu Biliyor muydunuz? : <span style="font-weight: normal; color: #000000">(Opsiyonel)<br />
                                            <asp:TextBox ID="txtBiliyor" runat="server" Width="400px" CssClass="form-control" Height="128px" TextMode="MultiLine"></asp:TextBox>
        </span>
        <br />
 </span>
    ...
    <p>
        <span style="color: #0000CC">Yayınlansın mı ?<br />
        </span>
    ...
    <p>
        ...
        <script>
            $(document).ready(function () {
                ...
                $("#ctl00_ContentPlaceHolder1_txtIcerik").summernote('code', '<div style="font-family: Arial;font-size:14px;color:#000;"><br></div>')
