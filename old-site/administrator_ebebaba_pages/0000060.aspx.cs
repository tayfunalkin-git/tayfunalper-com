...
public partial class administrator_ebebaba_pages_0000055 : System.Web.UI.Page
{
    ...
    void mesaj_yukle()
    {
        ...
        try
        {
            ...
            string sqltext = "select * from sorutable order by okundu desc,date(tarih) desc";
  ...
  LinkButton lbtn = new LinkButton();
                ...
                if (ebebaba_dt2.Rows[a]["okundu"].ToString() == "1")
                {
   ...
   protected void gelenmesajlar_PageIndexChanging(object sender, GridViewPageEventArgs e)
    ...
    protected void konu_Command(object sender, CommandEventArgs e)
    {
        ...
        Response.Redirect("0000062.aspx?kaynak=gelen_mesajlar&mesaj_id=" + mesaj_id);
            ...
            CheckBox isaret = new CheckBox();
                ...
                if (isaret.Checked == true)
                {
                    if (ebebaba_dt2.Rows[a]["okundu"].ToString() == "1")
                    {
                        ...
                        ebebaba_dt2.Rows[a]["okundu"] = "0";

                        okundu(ebebaba_dt2.Rows[a]["ID"].ToString());
    ...
    void okundu(string id) {
        ...
        { 
        MySqlConnection ebebaba_connection = ebebaba_class.connect_ebebaba(0301009184);
        MySqlCommand ebebaba_cmd3 = new MySqlCommand("update sorutable set okundu = '0' where ID=" + id + "", ebebaba_connection);
    ...
    void silinecekler(string id)
    {
        ...
        MySqlConnection ebebaba_connection = ebebaba_class.connect_ebebaba(0301009184);
        MySqlCommand ebebaba_cmd3 = new MySqlCommand("delete from sorutable where ID=" + id + "", ebebaba_connection);
        ebebaba_connection.Open();
        int eks3 = ebebaba_cmd3.ExecuteNonQuery();
        ebebaba_connection.Close();
    ...
    protected void Button3_Click1(object sender, ImageClickEventArgs e)
    {
        ...
        try
        {
            ...
            String Sqlifadesi = "Select * from sorutable where (gonderen like '%" + aranacak.Text.ToString() + "%' or soru like '%" + aranacak.Text.ToString() + "%' or eposta like '%" + aranacak.Text.ToString() + "%') order by okundu desc,date(tarih) desc";
