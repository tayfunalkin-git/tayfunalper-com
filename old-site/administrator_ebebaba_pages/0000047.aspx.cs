...
public partial class administrator_ebebaba_pages_0000047 : System.Web.UI.Page
{
    ...
    void alan_yukle()
    {
        ...
        try
        {
            ...
            foreach (GridViewRow str in list.Rows)
            {
                ...
                resim.ImageUrl = "~/imgkitap/" + ebebaba_dt.Rows[i]["resim"].ToString();
    ...
    protected void ad_guncelle_Command(object sender, CommandEventArgs e)
    {
        ...
        try
        {
            ...
            MySqlConnection ebebaba_connection = ebebaba_class.connect_ebebaba(0301009184);
            MySqlDataAdapter da = new MySqlDataAdapter("select * from kitaplar where id=" + e.CommandArgument.ToString() + "", ebebaba_connection);
            DataTable ebebaba_dt = new DataTable();
            da.Fill(ebebaba_dt);
            ...
            resim2.ImageUrl = "~/imgkitap/" + ebebaba_dt.Rows[0]["resim"].ToString();
    ...
    void yeniden_yukle()
    {
        ...
        try
        {
            ...
            MySqlConnection ebebaba_connection = ebebaba_class.connect_ebebaba(0301009184);
            MySqlDataAdapter da = new MySqlDataAdapter("select * from kitaplar where id=" + Label2.Text.ToString() + "", ebebaba_connection);
            DataTable ebebaba_dt = new DataTable();
            da.Fill(ebebaba_dt);
    ...
    protected void sil_Command(object sender, CommandEventArgs e)
    {
        ...
        try
        {
            ...
            MySqlDataAdapter da = new MySqlDataAdapter("select kitap_id from kitapkategorileri where kitap_id='"+e.CommandArgument.ToString()+"'", ebebaba_connection);
            DataTable ebebaba_dt = new DataTable();
            da.Fill(ebebaba_dt);
            ...
            MySqlCommand ebebaba_cmd2 = new MySqlCommand("update kitaplar set sira = sira - 1 where sira > " + e.CommandName.ToString() + "", ebebaba_connection);
            ...
            MySqlCommand ebebaba_cmd = new MySqlCommand("delete from kitaplar where id=" + e.CommandArgument.ToString() + "", ebebaba_connection);
            ...
            if (eks == 1)
            {
                ...
                sonuc.Text = "Kitap Kaydý Baþarýyla Silindi.";
            ...
            {
                panel_sonuc.Visible = true;
                sonuc.Text = "Kitap Kaydý Silme Ýþlemi Baþarýsýz !";
        ...
        {
            panel_sonuc.Visible = true;
            sonuc.Text = "Silinmek Ýstenilen Kitaba Ait Kategoriler Bulundu.Silme Ýþlemi Baþarýsýz !";
            sonuc.ForeColor = System.Drawing.Color.Red;
        }
        }
        catch
    ...
    protected void Button2_Click1(object sender, ImageClickEventArgs e)
    {
        ...
        try
        {
            ...
            MySqlConnection ebebaba_connection = ebebaba_class.connect_ebebaba(0301009184);
            MySqlCommand ebebaba_cmd = new MySqlCommand("update kitaplar set kitap_adi = '" + alanadi2.Text.TrimEnd().TrimStart().ToString() + "',goster='"+gstr+"' where id="+Label2.Text+"", ebebaba_connection);
            ...
            if (eks == 1)
            {
                ...
                panel_sonuc.Visible = true;
                sonuc.Text = "Kitap Bilgileri Baþarýyla Güncelleþtirildi";
                sonuc.ForeColor = System.Drawing.Color.Green;
            ...
            {
                panel_sonuc.Visible = true;
                sonuc.Text = "Kitap Bilgileri Güncelleþtirilmesi Baþarýsýz !";
                sonuc.ForeColor = System.Drawing.Color.Red;
    ...
    protected void ust_Command(object sender, CommandEventArgs e)
    {
        ...
        if (e.CommandName.ToString() != "1")
        {
            ...
            try
            {
                ...
                MySqlConnection ebebaba_connection = ebebaba_class.connect_ebebaba(0301009184);
                MySqlCommand ebebaba_cmd2 = new MySqlCommand("update kitaplar set sira = sira + 1 where sira=" + degisecek_sira + "", ebebaba_connection);
                ...
                MySqlCommand ebebaba_cmd = new MySqlCommand("update kitaplar set sira = " + degisecek_sira + "  where id=" + e.CommandArgument.ToString() + "", ebebaba_connection);
 ...
 guncelle.Visible = false;
        try
        {
            ...
            MySqlConnection ebebaba_connection = ebebaba_class.connect_ebebaba(0301009184);
            MySqlDataAdapter da = new MySqlDataAdapter("select max(sira) from kitaplar", ebebaba_connection);
            DataTable ebebaba_dt = new DataTable();
            da.Fill(ebebaba_dt);
    ...
    protected void goster_Command(object sender, CommandEventArgs e)
    {
        ...
        try
        {
            ...
            else
            {
                ...
                MySqlCommand ebebaba_cmd2 = new MySqlCommand("update kitaplar set goster='"+gstr.ToString()+"' where id=" + e.CommandArgument.ToString() + "", ebebaba_connection);
...
alan_yukle();
    ...
    void resim_yukle()
    {
        try
        {
            ...
            MySqlConnection ebebaba_connection = ebebaba_class.connect_ebebaba(0301009184);
            MySqlCommand cmd = new MySqlCommand("select * from kitaplar where resim='" + kitap_res.FileName + "'", ebebaba_connection);
            ebebaba_connection.Open();
            ...
            else
            {
                ...
                kitap_res.PostedFile.SaveAs(Server.MapPath("~/imgkitap/" + kitap_res.FileName));
    ...
    void kaydet()
    {
        ...
        try
        {
            ...
            MySqlCommand ebebaba_cmd = new MySqlCommand("insert into kitaplar(kitap_adi,sira,resim,goster) values ('" + alanadi1.Text.TrimEnd().TrimStart().ToString() + "'," + sirano + ",'"+kitap_res.FileName.ToString()+"','"+yyn.ToString()+"')", ebebaba_connection);
            ...
            if (eks == 1)
            {
                ...
                panel_sonuc.Visible = true;
                sonuc.Text = "Kitap Kaydý Baþarýyla Gerçekleþti";
                sonuc.ForeColor = System.Drawing.Color.Green;
            ...
            {
                panel_sonuc.Visible = true;
                sonuc.Text = "Kitap Kayýt Ýþlemi Baþarýsýz !";
                sonuc.ForeColor = System.Drawing.Color.Red;
    ...
    void resim_yukle22()
    {
        try
        {
            ...
            MySqlConnection ebebaba_connection = ebebaba_class.connect_ebebaba(0301009184);
            MySqlCommand cmd = new MySqlCommand("select * from kitaplar where resim='" + kitap_res2.FileName + "'", ebebaba_connection);
            ebebaba_connection.Open();
            object sonuc4 = cmd.ExecuteScalar();
            ebebaba_connection.Close();
            ...
            else
            {
                ...
                kitap_res2.PostedFile.SaveAs(Server.MapPath("~/imgkitap/" + kitap_res2.FileName));
    ...
    void kaydet22()
    {
        ...
        try
        {
            ...
            MySqlCommand ebebaba_cmd = new MySqlCommand("update kitaplar set resim='"+kitap_res2.FileName+"' where id="+Label2.Text+"", ebebaba_connection);
