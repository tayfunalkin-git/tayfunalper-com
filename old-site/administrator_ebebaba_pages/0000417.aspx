<%@ Page Language="C#" MasterPageFile="~/administrator_ebebaba_pages/Ebebaba_Master_New.master" AutoEventWireup="true" CodeFile="0000417.aspx.cs" Inherits="ivfyonetici_0000070" Debug="true" %>
                               ...
                               <tr>
                                   <td style="width: 372px; height: 24px;" valign="middle">
                                       &nbsp; <asp:Label ID="page_label" runat="server" Font-Bold="True" Font-Names="Arial"
                                                    Font-Size="11px" Text="Aylýk - Yýllýk Gebelik & Siklus Oraný Sorgulama" style="font-size: 12px"></asp:Label></td>
