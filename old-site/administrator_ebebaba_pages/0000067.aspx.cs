...
public partial class administrator_ebebaba_pages_0000067 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            if (Request.QueryString["kaynak"].ToString() != "giden_mesajlar" || Request.QueryString["mesaj_id"].ToString() != Session["mesaj_id10"].ToString())
            {


                Response.Redirect("0000065.aspx");
    ...
    void mesaji_yukle()
    {
        ...
        try
        {
            ...
            MySqlDataAdapter ebebaba_da2 = new MySqlDataAdapter("select * from yardim_tab_giden where mesaj_id="+Request.QueryString["mesaj_id"].ToString()+"", ebebaba_connection);
            DataTable ebebaba_dt2 = new DataTable();
            ebebaba_da2.Fill(ebebaba_dt2);


            Label3.Text = ebebaba_dt2.Rows[0]["ad_soyad"].ToString();
            Label7.Text = ebebaba_dt2.Rows[0]["email"].ToString();
    ...
    protected void Button2_Click1(object sender, ImageClickEventArgs e)
    {
        try
        {
            ...
            MySqlConnection ebebaba_connection = ebebaba_class.connect_ebebaba(0301009184);
            MySqlCommand ebebaba_cmd3 = new MySqlCommand("delete from yardim_tab_giden where mesaj_id=" + Request.QueryString["mesaj_id"].ToString() + "", ebebaba_connection);
