...
public partial class administrator_ebebaba_pages_0000011 : System.Web.UI.Page
{
    ...
    void mesaj_yukle()
    {
        ...
        try
        {
            ...
            string sqltext = "select * from iletisim_tab_giden order by date(tarih) desc";
   ...
   protected void gelenmesajlar_PageIndexChanging(object sender, GridViewPageEventArgs e)
    ...
    protected void konu_Command(object sender, CommandEventArgs e)
    {
        ...
        Response.Redirect("0000059.aspx?kaynak=giden_mesajlar&mesaj_id=" + mesaj_id);
    ...
    void silinecekler(string id)
    {
        try
        {
            ...
            MySqlConnection ebebaba_connection = ebebaba_class.connect_ebebaba(0301009184);
            MySqlCommand ebebaba_cmd3 = new MySqlCommand("delete from iletisim_tab_giden where mesaj_id=" + id + "", ebebaba_connection);
    ...
    protected void Button3_Click1(object sender, ImageClickEventArgs e)
    {
        ...
        try
        {
            ...
            String Sqlifadesi = "Select * from iletisim_tab_giden where (ad_soyad like '%" + aranacak.Text.ToString() + "%' or gonderen like '%" + aranacak.Text.ToString() + "%' or konu like '%" + aranacak.Text.ToString() + "%' or mesaj like '%" + aranacak.Text.ToString() + "%')order by date(tarih) desc";
