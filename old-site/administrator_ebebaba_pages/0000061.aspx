<%@ Page Language="C#" MasterPageFile="~/administrator_ebebaba_pages/Ebebaba_Master_New.master"  CodeFile="0000061.aspx.cs" Inherits="administrator_ebebaba_pages_0000011" Theme="SkinFile" EnableEventValidation="false" %>
...
style="WIDTH: 289px; HEIGHT: 24px" vAlign=middle> &nbsp;<asp:Label id="Label14" runat="server" 
                              Font-Size="11px" Font-Names="Tahoma" Font-Bold="True" 
                              Text="Giden Soru Mesajlarý"></asp:Label> 
