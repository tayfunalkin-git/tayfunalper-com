...
public partial class mainAdminPagesHdn_havuz : System.Web.UI.Page
{
    ...
    private void resimYukle()
    {
        ...
        MySqlDataAdapter da6 = new MySqlDataAdapter("Select * from resimhavuzuekip where onay='+' order by tarih desc", connect_word);
    ...
    protected void sil_Command(object sender, CommandEventArgs e)
    {
        ...
        MySqlConnection connect_word = noc.connect_ebebaba(0301009184);
        MySqlCommand cmd = new MySqlCommand("delete from  resimhavuzuekip where ID=" + e.CommandArgument.ToString() + "", connect_word);
    ...
    {
        Response.Redirect("resimYukleEkip.aspx?gonderen=" + Request.QueryString["gonderen"].ToString());
    }
}