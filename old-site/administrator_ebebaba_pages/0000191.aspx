<%@ Page Title="" Language="C#" MasterPageFile="~/administrator_ebebaba_pages/Ebebaba_Master_New.master" AutoEventWireup="true" CodeFile="0000191.aspx.cs" Inherits="mainAdminPagesHdn_0000073" %>
...
vAlign=middle> &nbsp;<asp:Label id="Label14" runat="server" Font-Size="11px" Font-Names="Tahoma" Font-Bold="True" Text="Kayıtlı Web Siteleri"></asp:Label></TD><TD 
style="HEIGHT: 24px; TEXT-ALIGN: right" vAlign=middle>  &nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;</TD></TR></TABLE></TD></TR></TABLE>
      ...
      <div class="form-group">  
          ...
          <br />
        <br />
                <asp:GridView ID="list" runat="server" AutoGenerateColumns="False" CellPadding="5" Font-Names="Calibri" Font-Size="12pt" ForeColor="#333333" OnRowDataBound="GridView1_RowDataBound" PageSize="5" Width="100%" GridLines="Horizontal" EnableModelValidation="True">
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText="Site Bilgileri">
                            <ItemTemplate>
                                ...
                                <br />
                               <asp:Image ID="resim" runat="server" Width="112px" ImageAlign="TextTop" />
                                            <br />
                                <br />
                        ...
                        <asp:BoundField DataField="footer" HeaderText="Footer Metni" />
