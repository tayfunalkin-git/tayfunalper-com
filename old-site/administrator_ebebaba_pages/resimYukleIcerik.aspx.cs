...
public partial class administrator_ebebaba_pages_resimYukle : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        MySqlCommand cmd = new MySqlCommand("Insert into resimhavuzuicerik(adi,tarih,onay) values (?1,?2,?3)", baglanti);
        ...
        if (eks == 1)
        {
            ...
            resim.SaveAs(Server.MapPath("~/uploadImages/" + resimAdi + "_1.jpg"));

            resimislem yeniresim2 = new resimislem();
            System.Drawing.Image kucuk2 = yeniresim2.ResimOlustur(600, Server.MapPath("~/uploadImages/" + resimAdi + "_1.jpg"));
            kucuk2.Save(Server.MapPath("~/uploadImages/" + resimAdi + ".jpg"));
            ...
            {
                Panel1.Visible = true;
                resim500.ImageUrl = "~/uploadImages/" + resimAdi + ".jpg";
    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
        ...
        if (W500.Value != "")
        {
            ...
            string ImageName = Label2.Text + ".jpg";
            ...
            using (MemoryStream ms = new MemoryStream(CropImage, 0, CropImage.Length))
            {
                ...
                {
                    string SaveTo = path + Label2.Text + "_thumb.jpg";
  ...
  //      this.ClientScript.RegisterClientScriptBlock(this.GetType(), "Close", "window.close()", true);
    ...
    private void digerleriniYukle()
    {
        MySqlConnection baglanti = noc.connect_ebebaba(0301009184);
        //resimislem yeniresim2 = new resimislem();
        //System.Drawing.Image kucuk2 = yeniresim2.ResimOlustur(300, Server.MapPath("~/uploadImages/" + Label2.Text + "_480.jpg"));

        //resimislem yeniresim3 = new resimislem();
        //System.Drawing.Image kucuk3 = yeniresim3.ResimOlustur(225, Server.MapPath("~/uploadImages/" + Label2.Text + "_480.jpg"));

        //kucuk2.Save(Server.MapPath("~/uploadImages/" + Label2.Text + "_300.jpg"));
        //kucuk3.Save(Server.MapPath("~/uploadImages/" + Label2.Text + "_225.jpg"));

        MySqlCommand cmd2 = new MySqlCommand("Update resimhavuzuicerik set onay='+' where ID=" + Label3.Text + "", baglanti);
        baglanti.Open();
        int eks2 = cmd2.ExecuteNonQuery();
        baglanti.Close();


        Response.Redirect("havuzicerik.aspx?gonderen=icerik");
