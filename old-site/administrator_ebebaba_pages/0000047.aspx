<%@ Page Language="C#"  EnableEventValidation="false" MasterPageFile="~/administrator_ebebaba_pages/Ebebaba_Master_New.master" AutoEventWireup="true" CodeFile="0000047.aspx.cs" Inherits="administrator_ebebaba_pages_0000047" Theme="SkinFile" %>
                ...
                <asp:Panel ID="guncelle" runat="server" align="center" HorizontalAlign="Left" Visible="False"
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" style="border-right: #000000 1px solid;
                                                        ...
                                                        <tr>
                                                            <td style="width: 202px; height: 24px" valign="middle">
                                                                &nbsp;<asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Names="Tahoma" Font-Size="11px"
                                                                    Text="Kitap Adý Güncelleme"></asp:Label>
                                                            </td>
                        ...
                        <tr style="font-size: 12pt; font-family: Times New Roman">
                            <td style="height: 26px; font-size: 11px; width: 97px; font-family: Tahoma;">
                                <span style="font-size: 11px; font-family: Verdana">&nbsp;Kitap <span style="font-family: Tahoma">
                                    Adý : </span></span>
                            </td>
                            <td colspan="2" style="height: 25px">
                                &nbsp;<asp:TextBox ID="alanadi2" runat="server" MaxLength="40" SkinID="txtNormal" ValidationGroup="gun"></asp:TextBox>
                        ...
                        <tr style="font-size: 12pt; font-family: Times New Roman">
                            <td style="height: 26px; font-size: 11px; width: 97px; font-family: Tahoma;">
                                <span style="font-size: 8pt"><span style="font-family: Verdana">&nbsp;<span style="font-size: 11px;
                                    font-family: Tahoma">Yayýnlansýn mý?</span></span><span style="font-family: Tahoma; font-size: 11px;"> : </span></span>
                            </td>
                            <td colspan="2" style="height: 26px">
                                <asp:CheckBox ID="yayin2" runat="server" BorderWidth="0px" ValidationGroup="gun" /></td>
                        </tr>
                        <tr style="font-size: 12pt; font-family: Times New Roman">
                            <td style="font-size: 11px; width: 97px; font-family: Tahoma; height: 26px" valign="top">
                                <span style="font-family: Tahoma"><span style="font-size: 8pt">&nbsp;<span style="font-size: 11px">Kitap
                                    Resmi</span></span><span style="font-size: 11px;"> : </span></span>
                            </td>
                            <td colspan="2" style="height: 123px" valign="top">
                                &nbsp;<asp:FileUpload ID="kitap_res2" runat="server" SkinID="fupload" />
                                <asp:ImageButton ID="ImageButton2" runat="server" AlternateText="Kitap Resmini Deðiþtir"
                                    ImageAlign="AbsMiddle" ImageUrl="~/imgs/kontrol.gif" OnClick="ImageButton2_Click"
                                    ValidationGroup="tunc" />
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="kitap_res2"
                                    Display="Dynamic" ErrorMessage="Kitap Resmi Seçilmedi !" Font-Bold="False" Font-Names="Tahoma"
                                    Font-Size="11px" SetFocusOnError="True" ValidationGroup="tunc"></asp:RequiredFieldValidator>
                                <br />
                                &nbsp;<asp:Image ID="resim2" runat="server" Height="75px" ImageAlign="AbsMiddle" Width="75px" /></td>
                        </tr>
                    </table>
                    <br />
                </asp:Panel>
                                        ...
                                        <tr>
                                            <td style="width: 202px; height: 24px" valign="middle">
                                                &nbsp;<asp:Label ID="Label14" runat="server" Font-Bold="True" Font-Names="Tahoma"
                                                    Font-Size="11px" Text="Kitaplar"></asp:Label>
                                            </td>
                        ...
                        width="100%">
                                    <tr>
                                        <td style="height: 25px; font-weight: normal; width: 96px; text-align: left;">
                                            <span style="font-size: 11px; font-family: Verdana"><span style="font-family: Tahoma">
                                                Kitap <span>Adý : </span></span></span>
                                        </td>
                                        <td colspan="2" style="height: 25px; font-family: Tahoma; text-align: left;">
                                            &nbsp;
                                <asp:TextBox ID="alanadi1" runat="server" MaxLength="40" SkinID="txtNormal" ValidationGroup="kyd"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="alanadi1"
                                    Display="Dynamic" ErrorMessage="Kitap Adý Boþ Geçilemez !" Font-Bold="False" Font-Names="Tahoma" Font-Size="11px"
                                ...
                                <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="alanadi1"
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="2" style="font-family: Tahoma; height: 25px; text-align: left">
                                            &nbsp;
                                            <asp:FileUpload ID="kitap_res" runat="server" SkinID="fupload" />
            ...
            <td valign="top">
                <div align="left" style="text-align: left">
                    <asp:GridView ID="list" runat="server" AutoGenerateColumns="False" BorderColor="White"
                        ...
                        <Columns>
                            <asp:TemplateField HeaderText="Kitap Adlarý">
                                <ItemTemplate>
