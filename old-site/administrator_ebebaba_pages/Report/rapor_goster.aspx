<%@ Page Language="C#" AutoEventWireup="true"  Theme="SkinFile" CodeFile="rapor_goster.aspx.cs" Inherits="rapor_admin" %>
        ...
        <table align="center" border="0" cellpadding="0" cellspacing="0" style="border-right: #000000 1px solid;
            ...
            <tr>
                <td style="border-top-width: 1px; border-left-width: 1px; border-left-color: #d3d3d3;
                    ...
                    <asp:LinkButton ID="s_ekran" runat="server" Font-Bold="True" Font-Names="Arial" Font-Size="11px"
                        OnClick="s_ekran_Click">Sorgu Ekranı</asp:LinkButton>&nbsp;</td>
            </tr>
