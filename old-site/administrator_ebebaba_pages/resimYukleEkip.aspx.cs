...
public partial class administrator_ebebaba_pages_resimYukle : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        MySqlCommand cmd = new MySqlCommand("Insert into resimhavuzuekip(adi,tarih,onay) values (?1,?2,?3)", baglanti);
        ...
        if (eks == 1)
        {
            ...
            if (dosya.Exists)
            {
                ...
                System.Drawing.Image kucuk2 = yeniresim2.ResimOlustur(500, Server.MapPath("~/uploadImages/" + Label2.Text + ".jpg"));
  ...
  //      this.ClientScript.RegisterClientScriptBlock(this.GetType(), "Close", "window.close()", true);
    ...
    private void digerleriniYukle()
    {
        ...
        MySqlCommand cmd2 = new MySqlCommand("Update resimhavuzuekip set onay='+' where ID=" + Label3.Text + "", baglanti);
        baglanti.Open();
        int eks2 = cmd2.ExecuteNonQuery();
        baglanti.Close();


        Response.Redirect("havuzEkip.aspx?gonderen=kapak");
