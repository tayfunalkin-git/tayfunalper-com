<%@ Page Title="" Language="C#" MasterPageFile="~/administrator_ebebaba_pages/Ebebaba_Master_New.master" EnableEventValidation="false" ValidateRequest="false" AutoEventWireup="true" CodeFile="0000175.aspx.cs" Inherits="mainAdminPagesHdn_0000073" %>
...
vAlign=middle> &nbsp;<asp:Label id="Label14" runat="server" Font-Size="11px" Font-Names="Tahoma" Font-Bold="True" Text="Yeni Ekip Üyesi Ekle"></asp:Label></TD><TD 
style="HEIGHT: 24px; TEXT-ALIGN: right" vAlign=middle>  &nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;</TD></TR></TABLE></TD></TR></TABLE>
    ...
    <p>
        ...
        <br />
                                                Pozisyon :<asp:DropDownList ID="kategoriList" runat="server" CssClass="form-control" Width="198px">
        </asp:DropDownList>
        <br />
        E-Posta Adresi :
        </span><span style="font-weight: normal; color: #000000">(Opsiyonel)</span><span style="color: #0000CC"><asp:TextBox ID="txtPosta" runat="server" Width="300px" CssClass="form-control"></asp:TextBox>
        &nbsp;
        <br />
                                                Resim : <br />
        </span>
    ...
    <div id="secilenKapakResmi" runat="server">
        ...
        </span><span style="color: #000000; font-weight: normal;">(Opsiyonel)</span><span style="color: #0000CC">
            <br />
            </span><span style="color: #000000; font-weight: normal;"><span style="color: #0000CC">
