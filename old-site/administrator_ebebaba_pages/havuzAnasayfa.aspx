<%@ Page Language="C#" AutoEventWireup="true" Debug="true" CodeFile="havuzAnasayfa.aspx.cs" Inherits="mainAdminPagesHdn_havuz" %>
...
<body>
    ...
    <div>
        ...
        <table class="auto-style1" cellpadding="0" cellspacing="0">
            <tr>
                <td class="auto-style2">
                    <asp:Label ID="Label1" runat="server" style="font-size: 20px; font-weight: 700;" Text="ANASAYFA RESİM HAVUZU"></asp:Label>
                </td>
        ...
        <br />
        Anasayfa Resim Havuzundaki Resim Sayısı : <asp:Label ID="Label15" runat="server" style="color: #000099"></asp:Label>
