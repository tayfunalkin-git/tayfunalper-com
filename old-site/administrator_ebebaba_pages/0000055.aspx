<%@ Page Language="C#" MasterPageFile="~/administrator_ebebaba_pages/Ebebaba_Master_New.master"  CodeFile="0000055.aspx.cs" Inherits="administrator_ebebaba_pages_0000055" Theme="SkinFile" EnableEventValidation="false" %>
...
cellPadding=0><TBODY><TR><TD style="WIDTH: 253px; HEIGHT: 24px" 
vAlign=middle> &nbsp;<asp:Label id="Label14" runat="server" Font-Size="11px" Font-Names="Tahoma" Font-Bold="True" Text="Gelen Ýletiþim Mesajlarý"></asp:Label>
                                        ...
                                        <tr>
                                            <td style="font-size: 11px; color: gray; font-family: verdana; height: 23px" colspan="7">
                                                                <asp:GridView ID="gelenmesajlar" runat="server" AutoGenerateColumns="False" BorderColor="White"
                                                                    ...
                                                                    <RowStyle Height="20px" Font-Names="Tahoma" Font-Size="11px" />
                                                                    <SelectedRowStyle BackColor="Yellow" Wrap="True" />
                                                                    <PagerStyle BackColor="WhiteSmoke" HorizontalAlign="Right" Font-Names="Tahoma" Font-Size="11px" ForeColor="Gray" />
