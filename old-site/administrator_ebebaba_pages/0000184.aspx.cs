...
public partial class mainAdminPagesHdn_0000073 : System.Web.UI.Page
{
    ...
    private void yukle1()
    {
        ...
        MySqlDataAdapter da = new MySqlDataAdapter("Select * from anasayfatasarimi where ID=5", connect_word);
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        MySqlConnection connect_word = noc.connect_ebebaba(0301009184);
        MySqlCommand cmd = new MySqlCommand("Update anasayfatasarimi set satir1=?1,satir2=?2,satir3=?3,satir4=?4,satir5=?5,yayin=?6,resim=?10,arkaplan=?11,hizalama=?12 where ID=5", connect_word);
