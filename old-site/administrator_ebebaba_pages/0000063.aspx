<%@ Page Language="C#" MasterPageFile="~/administrator_ebebaba_pages/Ebebaba_Master_New.master" AutoEventWireup="true" CodeFile="0000063.aspx.cs" Inherits="administrator_ebebaba_pages_0000023" Theme="SkinFile"%>
...
style="WIDTH: 202px; HEIGHT: 24px" vAlign=middle> &nbsp;
    <asp:Label id="Label14" runat="server" Font-Size="11px" Font-Names="Tahoma" Font-Bold="True" 
                               Text="Gönderilen Cevap Mesaj Bilgisi"></asp:Label> 
