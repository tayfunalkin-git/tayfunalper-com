...
public partial class administrator_ebebaba_pages_0000022 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            if (Request.QueryString["kaynak"].ToString() != "gelen_mesajlar" || Request.QueryString["mesaj_id"].ToString() != Session["mesaj_id7"].ToString())
            {
                ...
                Response.Redirect("0000055.aspx");
    ...
    void mesaji_yukle()
    {
        ...
        try
        {
            ...
            MySqlDataAdapter ebebaba_da2 = new MySqlDataAdapter("select * from iletisim_tab where mesaj_id="+Request.QueryString["mesaj_id"].ToString()+"", ebebaba_connection);
            ...
            Label11.Text = ebebaba_dt2.Rows[0]["tel"].ToString();
            Label12.Text = ebebaba_dt2.Rows[0]["email"].ToString();


            msjkonu.Text = ebebaba_dt2.Rows[0]["konu"].ToString();
            ...
            MySqlCommand ebebaba_cmd3 = new MySqlCommand("update iletisim_tab set hit = '0' where mesaj_id=" + Request.QueryString["mesaj_id"].ToString() + "", ebebaba_connection);
 ...
 try
        {
            ...
            MySqlConnection ebebaba_connection = ebebaba_class.connect_ebebaba(0301009184);
            MySqlCommand ebebaba_cmd3 = new MySqlCommand("Delete from iletisim_tab where mesaj_id=" + Request.QueryString["mesaj_id"].ToString() + "", ebebaba_connection);
            ebebaba_connection.Open();
            int eks3 = ebebaba_cmd3.ExecuteNonQuery();
            ebebaba_connection.Close();
    ...
    protected void btnKaydet_Click1(object sender, ImageClickEventArgs e)
    {
        ...
        try
        {
            ...
            MySqlCommand ebebaba_cmd2 = new MySqlCommand("insert into iletisim_tab_giden(ad_soyad,gonderen,konu,mesaj,tarih,email,tel) values (?1,?2,?3,?4,?5,?6,?7)", ebebaba_connection);
            ...
            ebebaba_cmd2.Parameters.AddWithValue("?7", Label11.Text);
            ...
            MySqlCommand ebebaba_cmd3 = new MySqlCommand("Update iletisim_tab set cevap='1' where mesaj_id=" + Request.QueryString["mesaj_id"].ToString() + "", ebebaba_connection);
            ebebaba_connection.Open();
            int eks3 = ebebaba_cmd3.ExecuteNonQuery();
            ebebaba_connection.Close();
            ...
            if (Label12.Text != "")
            {
                ...
                string mesaj2 = "<font face='Tahoma'>Merhaba " + Label8.Text.ToUpper().TrimStart().TrimEnd();
                mesaj2 = mesaj2 + "<br>" + Label6.Text + " tarihinde sitemiz üzerinden iletiþim formu ile gönderdiðiniz mesaj,"+Label7.Text +" tarafýndan aþaðýdaki þekilde cevaplanmýþtýr ;<br>";
                ...
                fc.mailsend("Cevap :"+msjkonu.Text, Label12.Text, mesaj2);
                fc.mailsend("Cevap :" + msjkonu.Text, "y_tayfun_alper@yahoo.com", mesaj2);
            ...
            if (eks2 == 1 && eks3 == 1)
            {
                ...
                Response.Redirect("0000056.aspx");
