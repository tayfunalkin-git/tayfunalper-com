...
public partial class ivfyonetici_0000070 : System.Web.UI.Page
{
    ...
    void siklusyukle31()
    {
        ...
        ////siklus_ana_tab S,labSonuc L,labProtokol as P,uye_hasta U,kisa_siklus K,atama as A,uye_doktor as D where L.siklusID=S.siklus_id and P.siklusID=S.siklus_id and U.uye_id = CAST(S.hasta_id as UNSIGNED) and K.siklus_id=S.siklus_id and A.siklusID=S.siklus_id and A.doktorID=D.uye_id and K.alan3 <>'' and str_to_date(K.alan3 ,'%d.%m.%Y') >= '" + baslangictarihi + "' and str_to_date(K.alan3 ,'%d.%m.%Y') <= '" + bitistarihi + "' and
        //if (txtkurum.SelectedIndex == 0 && txttedavituru.SelectedIndex == 0 && txttedaviprotokolu.SelectedIndex == 0)
        //{
