<%@ Page Language="C#" AutoEventWireup="true" CodeFile="resimYukleAnasayfa.aspx.cs" Debug="true" Inherits="administrator_ebebaba_pages_resimYukle" %>
...
&nbsp;<asp:FileUpload ID="resim" runat="server" CssClass="form-control" />
        ...
        <asp:Panel ID="Panel1" runat="server" Visible="False">
            <table class="auto-style1" style="font-family: arial, Helvetica, sans-serif; font-size: 12px; font-weight: bold;">
                <tr>
                    <td>
                        <asp:Image ID="resim500" runat="server" style="width:600px;"/>
                    </td>
                </tr>
            </table>
