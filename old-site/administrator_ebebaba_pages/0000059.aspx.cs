...
public partial class administrator_ebebaba_pages_0000023 : System.Web.UI.Page
{
    ...
    void mesaji_yukle()
    {
        ...
        try
        {
            ...
            MySqlDataAdapter ebebaba_da2 = new MySqlDataAdapter("select * from iletisim_tab_giden where mesaj_id="+Request.QueryString["mesaj_id"].ToString()+"", ebebaba_connection);
            ...
            Label1.Text = ebebaba_dt2.Rows[0]["tel"].ToString();
    ...
    protected void Button2_Click1(object sender, ImageClickEventArgs e)
    {
        try
        {
            ...
            MySqlConnection ebebaba_connection = ebebaba_class.connect_ebebaba(0301009184);
            MySqlCommand ebebaba_cmd3 = new MySqlCommand("delete from iletisim_tab_giden where mesaj_id=" + Request.QueryString["mesaj_id"].ToString() + "", ebebaba_connection);
