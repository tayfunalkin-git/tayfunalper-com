...
public partial class administrator_ebebaba_pages_resimYukle : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        MySqlCommand cmd = new MySqlCommand("Insert into resimhavuzu(adi,tarih,onay) values (?1,?2,?3)", baglanti);
        ...
        if (eks == 1)
        {
            ...
            if (dosya.Exists)
            {
                ...
                //resimislem yeniresim22 = new resimislem();
                //System.Drawing.Image kucuk22 = yeniresim2.ResimOlustur(800, Server.MapPath("~/otelImages/" + Label2.Text + ".jpg"));
                //kucuk22.Save(Server.MapPath("~/otelImages/" + Label2.Text + "_800.jpg"));
    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
        ...
        using (MemoryStream ms = new MemoryStream(CropImage, 0, CropImage.Length))
        {
            ...
            {
                string SaveTo = path + Label2.Text + "_480.jpg";
  ...
  //      this.ClientScript.RegisterClientScriptBlock(this.GetType(), "Close", "window.close()", true);
    ...
    private void digerleriniYukle()
    {
        ...
        MySqlCommand cmd2 = new MySqlCommand("Update resimhavuzu set onay='+' where ID=" + Label3.Text + "", baglanti);
        baglanti.Open();
        int eks2 = cmd2.ExecuteNonQuery();
        baglanti.Close();


        Response.Redirect("havuz.aspx?gonderen=kapak");
