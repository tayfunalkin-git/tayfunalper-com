<%@ Page Language="C#" AutoEventWireup="true" Debug="true" CodeFile="havuzicerik.aspx.cs" Inherits="mainAdminPagesHdn_havuz" %>
    ...
    <script>
        ...
        function ekle(resimAdi, tur) {
            ...
            if (tur == "kapak") {
                ...
                var gosterilecekYer = "secilenKapakResmi";
                var html = "<img src='../uploadImages/" + resimAdi + "_225.jpg'/>";
                parent.$("#" + anaNesneAdi).val(resimAdi);
                parent.$("#" + gosterilecekYer).html(html);
                window.parent.jQuery.colorbox.close();
            }
            else if (tur == "icerik") {

                var anaNesneAdi = "ctl00_ContentPlaceHolder1_txtIcerik";
                var html = "<br><img src='../uploadImages/" + resimAdi + "_thumb.jpg'/><br>";
                window.opener.parent.$("#" + anaNesneAdi).summernote('pasteHTML', html);
                window.close();
            }
        }
        ...
        <table class="auto-style1" cellpadding="0" cellspacing="0">
            <tr>
                <td class="auto-style2">
                    <asp:Label ID="Label1" runat="server" style="font-size: 20px" Text="İÇERİK RESİM HAVUZU"></asp:Label>
                </td>
                <td style="text-align: right">
                    <asp:Button ID="Button1" runat="server" CssClass="btn_2" Text="YENİ İÇERİK RESMİ YÜKLE" OnClick="Button1_Click" />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                </td>
            </tr>
        </table>
        <br />
        İçerik Resim Havuzundaki Resim Sayısı : <asp:Label ID="Label15" runat="server" style="color: #000099"></asp:Label>
