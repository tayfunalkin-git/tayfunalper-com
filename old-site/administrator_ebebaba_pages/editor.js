...
//    { name: "headline",     className: "headline",  classStyle: "font-family: Tahoma black, Tahoma; font-size: 28px; letter-spacing: -2px;" },
//    { name: "Tahoma red",    className: "headline2", classStyle: "font-family: Tahoma black, Tahoma; font-size: 12px; letter-spacing: -2px; color:red" },
...
function editor_action(button_id) {
  ...
  // fgColor and bgColor
    ...
    var newcolor = showModalDialog(_editor_url + "popups/select_color.htm", oldcolor, "resizable: no; help: no; status: no; scroll: no;");
  ...
  // commandID and pass it to execCommand().   See http://msdn.microsoft.com/workshop/author/dhtml/reference/commandids.asp
    ...
    // insert image
      ...
      showModalDialog(_editor_url + "popups/inser_image.htm", editdoc, "resizable: no; help: no; status: no; scroll: no; ");
    }

    // insert table
    else if (cmdID.toLowerCase() == 'inserttable'){
      showModalDialog(_editor_url + "popups/insert_table.htm?"+objname,
                                 window,
                                 "resizable: yes; help: no; status: no; scroll: no; ");
    }
...
function editor_cMenu_generate(editorWin,objname) {
  ...
  var cMenuHeader = ''
    ...
    + '<table border=0 cellspacing=0 cellpadding=0 width="100%" style="width: 167px; background-color: white; border: solid 1px; border-color: threedhighlight threedshadow threedshadow threedhighlight;">'
