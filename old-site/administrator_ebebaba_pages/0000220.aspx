<%@ Page Language="C#" MasterPageFile="~/administrator_ebebaba_pages/Ebebaba_Master_New.master" AutoEventWireup="true" CodeFile="0000220.aspx.cs" Inherits="ivfyonetici_0000070" Debug="true" %>
                                                            ...
                                                            font-family: arial; background-color: #5d7b9d; text-align: center; border-right: black 1px solid; border-top: black 1px solid; border-left: black 1px solid; border-bottom: black 1px solid;">
                                                                    ...
                                                                    <asp:GridView ID="detay4" runat="server" AutoGenerateColumns="False" CellPadding="3" EnableModelValidation="True" Font-Bold="False" Font-Names="Arial" Font-Size="11px" ForeColor="#333333" Style="display:none;" Width="900px">
                                                                        ...
                                                                        <Columns>
                                                                            <asp:TemplateField>
                                                                                <ItemTemplate>
                                                                                    <asp:ImageButton ID="edt0" runat="server" ImageUrl="~/ivfyonetici/hasta_modulu/images/edit.png" />
                                                                                </ItemTemplate>
                                                                                <ItemStyle Width="30px" />
                                                                            </asp:TemplateField>
                                                                            <asp:TemplateField HeaderText="Adý ve Soyadý">
                                                                                <ItemTemplate>
                                                                                    <asp:LinkButton ID="lbAd0" runat="server" Font-Underline="False" ForeColor="Black" OnCommand="lbAd_Command"></asp:LinkButton>
                                                                                </ItemTemplate>
                                                                                <ItemStyle Width="140px" />
                                                                            </asp:TemplateField>
                                                                            <asp:BoundField DataField="yas" HeaderText="Yaþ" ItemStyle-Width="20px">
                                                         ...
                                                         <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                                            ...
                                                            font-family: arial; background-color: #5d7b9d; text-align: center; border-right: black 1px solid; border-top: black 1px solid; border-left: black 1px solid; border-bottom: black 1px solid;">
                                                                                    ...
                                                                                    Font-Size="11px" ForeColor="Red"></asp:Label>
                                                                                       ...
                                                                                       <asp:GridView ID="detay5" runat="server" AutoGenerateColumns="False" CellPadding="3" EnableModelValidation="True" Font-Bold="False" Font-Names="Arial" Font-Size="11px" ForeColor="#333333" style="margin-right: 0px" Width="900px">
                                                                                           ...
                                                                                           <Columns>
                                                                                               <asp:TemplateField>
                                                                                                   <ItemTemplate>
                                                                                                       <asp:ImageButton ID="edt1" runat="server" ImageUrl="~/ivfyonetici/hasta_modulu/images/edit.png" OnCommand="edt1_Command" />
                                                                                                       <asp:ImageButton ID="save0" runat="server" ImageUrl="~/ivfyonetici/hasta_modulu/images/save.png" OnCommand="save0_Command" ValidationGroup="erkek" Visible="False" />
                                                                            ...
                                                                            <asp:BoundField DataField="ET" HeaderText="ET" ItemStyle-Width="72px" />--%>
                                                                                               <asp:TemplateField HeaderText="Adý Soyadý">
                                                                                                   <ItemTemplate>
                                                                                                       <asp:LinkButton ID="adiSoyadi0" runat="server" Font-Underline="False" ForeColor="Black" OnCommand="adiSoyadi_Command"></asp:LinkButton>
                                                                                                   </ItemTemplate>
                                                                                                   <ItemStyle Width="280px" />
                                                                                               </asp:TemplateField>
                                                                                               <asp:TemplateField HeaderText="Çalýþma Protokol Kodu">
