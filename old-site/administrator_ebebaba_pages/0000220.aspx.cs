        ...
        if (suzgec.SelectedIndex == 0)
        {
            ...
            foreach (DataListItem str in list.Items)
            {
                ...
                foreach (GridViewRow satir in listehasta.Rows)
                {
                    ...
                    edt.OnClientClick = "window.open('mp55thumb.aspx?id=" + gebelikdt4.Rows[klm]["SID"].ToString() + "','','location=0,status=0,scrollbars=1,width=350,height=350');return false;";
        ...
        else
        {
            ...
            foreach (DataListItem str in list.Items)
            {
                ...
                foreach (GridViewRow satir in listehasta.Rows)
                {
                    ...
                    //edt.CommandArgument = gebelikdt4.Rows[klm]["SID"].ToString();
                    edt.OnClientClick = "window.open('mp55thumb.aspx?id=" + gebelikdt4.Rows[klm]["SID"].ToString() + "','','location=1,status=0,scrollbars=1,width=350,height=350');return false;";
                    lbAd = (LinkButton)satir.FindControl("lbAd");
                    lbAd.Text = gebelikdt4.Rows[klm]["ad"].ToString();
                    //edt.CommandArgument = gebelikdt4.Rows[klm]["SID"].ToString();
                    edt.OnClientClick = "window.open('mp55thumb.aspx?id=" + gebelikdt4.Rows[klm]["SID"].ToString() + "','','location=0,status=0,scrollbars=1,width=350,height=350');return false;";
        ...
        if (suzgec.SelectedIndex == 0)
        {
            ...
            foreach (DataListItem str in list4.Items)
            {
                ...
                foreach (GridViewRow satir in listehasta.Rows)
                {
                    ...
                    edt0.OnClientClick = "window.open('mp55thumb.aspx?id=" + gebelikdt4.Rows[klm]["SID"].ToString() + "','','location=0,status=0,scrollbars=1,width=350,height=350');return false;";
