<%@ Page Language="C#" AutoEventWireup="true" Debug="true" CodeFile="havuz.aspx.cs" Inherits="mainAdminPagesHdn_havuz" %>
        ...
        function ekle(resimAdi,tur)
        {
           ...
           window.close();
            ...
            else if (tur == "icerik")
            {
                ...
                var html = "<br><img src='../uploadImages/" + resimAdi + "_480.jpg'/><br>";
        ...
        <table class="auto-style1" cellpadding="0" cellspacing="0">
            <tr>
                <td class="auto-style2">
                    <asp:Label ID="Label1" runat="server" style="font-size: 20px" Text="KAPAK RESİM HAVUZU"></asp:Label>
                </td>
                <td style="text-align: right">
                    <asp:Button ID="Button1" runat="server" CssClass="btn_2" Text="YENİ KAPAK RESMİ YÜKLE" OnClick="Button1_Click" />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                </td>
            </tr>
        </table>
        <br />
        Kapak Resim Havuzundaki Resim Sayısı : <asp:Label ID="Label15" runat="server" style="color: #000099"></asp:Label>
