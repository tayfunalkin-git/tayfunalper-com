<%@ Page Language="C#" MasterPageFile="~/administrator_ebebaba_pages/Ebebaba_Master_New.master" AutoEventWireup="true" CodeFile="0000059.aspx.cs" Inherits="administrator_ebebaba_pages_0000023" Theme="SkinFile"%>
...
style="WIDTH: 202px; HEIGHT: 24px" vAlign=middle> &nbsp;
    <asp:Label id="Label14" runat="server" Font-Size="11px" Font-Names="Tahoma" Font-Bold="True" Text="Giden Ýletiþim Mesaj Bilgisi"></asp:Label> 
                    ...
                    <table style="overflow: hidden; clip: rect(10px 10px 10px 10px)" width="100%" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            ...
                            <td style="font-size: 11px; color: gray; font-family: verdana; height: 15px;" colspan="5" valign="middle">
                                ...
                                &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;<span style="font-family: Tahoma">
                                    &nbsp;</span><span
                                    style="color: black"><span style="font-family: Tahoma">Tarih :</span>
                                    <asp:Label ID="Label6" runat="server" Font-Bold="True" Font-Names="Tahoma" Font-Size="11px"></asp:Label>
                                        &nbsp; &nbsp; &nbsp; Tel :<asp:Label ID="Label1" runat="server" Font-Bold="True"
                                            Font-Names="Tahoma" Font-Size="11px"></asp:Label></span></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td style="font-size: 11px; width: 92px; color: black; font-family: verdana; height: 15px"
                                valign="middle">
                                <span style="font-family: Tahoma">Email :</span></td>
                            <td colspan="5" style="font-size: 11px; color: gray; font-family: verdana; height: 15px"
                                valign="middle">
                                <asp:Label ID="Label7" runat="server" Font-Bold="True" Font-Names="Tahoma" Font-Size="11px"
                        ...
                        <tr>
                            ...
                            <td colspan="5" style="font-size: 11px; color: gray; font-family: verdana; height: 15px;" valign="middle">
                                <asp:Label ID="Label4" runat="server" ForeColor="Navy" Font-Bold="True" Font-Names="Tahoma" Font-Size="11px"></asp:Label></td>
                        </tr>
                        <tr>
                            <td style="font-size: 11px; width: 62px; color: gray; font-family: verdana; height: 14px;">
                            </td>
                        ...
                        <tr>
                            ...
                            <td style="font-size: 11px; color: black; font-family: verdana; height: 15px;" colspan="5" valign="middle">
                                <asp:Label ID="Label5" runat="server" Font-Bold="True" Font-Names="Tahoma" Font-Size="11px"></asp:Label></td>
                        </tr>
                        <tr>
