<%@ Page Title="" Language="C#" MasterPageFile="~/administrator_ebebaba_pages/Ebebaba_Master_New.master" AutoEventWireup="true" CodeFile="0000194.aspx.cs" Inherits="mainAdminPagesHdn_0000073" %>
...
vAlign=middle> &nbsp;<asp:Label id="Label14" runat="server" Font-Size="11px" Font-Names="Tahoma" Font-Bold="True" Text="Kayıtlı İçerik Yazıları"></asp:Label></TD><TD 
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText="Başlık">
                            <ItemTemplate>
                                ...
                                <br />
                                <asp:Label ID="lblLink" runat="server" style="color: #0000CC"></asp:Label>
