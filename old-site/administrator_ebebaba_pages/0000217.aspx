<%@ Page Language="C#" MasterPageFile="~/administrator_ebebaba_pages/Ebebaba_Master_New.master" AutoEventWireup="true" CodeFile="0000217.aspx.cs" Inherits="ivfyonetici_0000070" Debug="true" %>
                   ...
                   <tr>
                       <td background="../imgs/ust_menu_bg.jpg" colspan="2" style="height: 33px">
                           <table cellpadding="0" cellspacing="0" style="width: 100%">
                               <tr>
                                   <td style="width: 372px; height: 24px;" valign="middle">
                                       &nbsp; <asp:Label ID="page_label" runat="server" Font-Bold="True" Font-Names="Arial"
                                                    Font-Size="11px" Text="Çalýþma Takip" style="font-size: 12px"></asp:Label></td>
                                ...
                                <div align="left">
                                    <table style="width: 90%" align="center">
                                        <tr>
                                            ...
                                            <td style="font-size: 11px; width: 14px; color: black; font-family: Arial; height: 10px">
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td style="font-size: 11px; color: black; font-family: Arial; width: 14px; height: 20px;">
                                            </td>
                                        ...
                                        <tr>
                                            <td style="width: 9px; height: 24px">
                                                &nbsp;</td>
                                            <td style="width: 84px; height: 24px">
                                                <span style="font-size: 11px; font-family: Arial">Kategori</span></td>
                                            <td style="width: 6px; height: 24px">
                                                :</td>
                                            <td style="width: 115px; height: 24px">
                                                <asp:DropDownList ID="kategori" runat="server" SkinID="drop">
                                        ...
                                        <tr>
                                            ...
                                            <td style="height: 30px" colspan="5">
                                                <asp:Button ID="Button1" runat="server" Text="Sorgula" Visible="False" OnClick="Button1_Click" /><asp:Button
                                                    ID="Button3" runat="server" Text="Tüm OPU'lar"
                                                    Width="110px" OnClick="Button3_Click" />&nbsp;<asp:Button
                                                    ID="Button4" runat="server" OnClick="Button4_Click" Text="Çalýþma Takip"
                                                    Width="112px" />
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                        <tr>
                                            <td background="../imgs/ust_menu_bg.jpg" colspan="2" style="height: 33px">
                                                <table cellpadding="0" cellspacing="0" style="width: 100%">
                                                    <tr>
                                                        <td style="width: 304px; height: 24px; text-align: left;" valign="middle">
                                                           ...
                                                           <td style="border: 1px solid black; background-color: ghostwhite; text-align: center; ">
                                                               &nbsp;</td>
                                                                        ...
                                                                        <Columns>
                                                                         <asp:TemplateField>
                                                            <ItemTemplate>
                                                                <asp:ImageButton ID="edt" runat="server" 
                                                                    ImageUrl="~/ivfyonetici/hasta_modulu/images/edit.png" />
                                                            </ItemTemplate>
                                                                             <ItemStyle Width="30px" />
                                                        </asp:TemplateField>
                                                                            <asp:TemplateField HeaderText="Adý ve Soyadý">
                                                                                <ItemTemplate>
                                                                                    <asp:LinkButton ID="lbAd" runat="server" Font-Underline="False" ForeColor="Black" OnCommand="lbAd_Command"></asp:LinkButton>
                                                                                </ItemTemplate>
                                                                        ...
                                                                        <tr>
                                                                             ...
                                                                             <td style="width: 70px; height: 20px; background-color: aliceblue; text-align: center; border-right: black 1px solid; border-top: black 1px solid; border-left: black 1px solid; border-bottom: black 1px solid;">
                                                                               ...
                                                                               <asp:GridView ID="detay3" runat="server"  AutoGenerateColumns="False" CellPadding="3" EnableModelValidation="True" Font-Bold="False" Font-Names="Arial" Font-Size="11px" ForeColor="#333333" Width="900px">
                                                                                   ...
                                                                                   <Columns>
                                                                                       <asp:TemplateField>
                                                                                           <ItemTemplate>
                                                                                               <asp:ImageButton ID="edt" runat="server" ImageUrl="~/ivfyonetici/hasta_modulu/images/edit.png" OnCommand="editres_Command" />
                                                                                               <asp:ImageButton ID="save" runat="server" ImageUrl="~/ivfyonetici/hasta_modulu/images/save.png" OnCommand="save_Command" Visible="False" />
                                                                            ...
                                                                            <asp:BoundField DataField="ET" HeaderText="ET" ItemStyle-Width="72px" />--%>
                                                                                       <asp:TemplateField HeaderText="Adý Soyadý">
                                                                                           <ItemTemplate>
                                                                                               <asp:LinkButton ID="adiSoyadi" runat="server" Font-Underline="False" ForeColor="Black" OnCommand="adiSoyadi_Command"></asp:LinkButton>
                                    ...
                                    <table style="width: 100%">
                                        <tr>
                                            <td style="height: 34px; text-align: center">
                                                ...
                                                <asp:DropDownList ID="sonc" runat="server">
