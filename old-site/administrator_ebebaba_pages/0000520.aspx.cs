...
public partial class ivfyonetici_0000070 : System.Web.UI.Page
{
    ...
    void kaynakHYukle()
    {
        ...
        MySqlDataAdapter da5 = new MySqlDataAdapter("Select concat(uye_adi,' ',uye_soyadi) as ad,uye_id as ID from uye_hasta order by ad asc", connect_word);
        DataTable dt5 = new DataTable();
        da5.Fill(dt5);

        drpH.DataSource = dt5;
        drpH.DataTextField = dt5.Columns["ad"].ToString();
        drpH.DataValueField = dt5.Columns["ID"].ToString();
        drpH.DataBind();
        ...
        yeni.Text = "Tümü";
        yeni.Value = "";
        drpH.Items.Insert(0, yeni);
    
    }
    private void kaynakKYukle()
    {
        MySqlConnection connect_word = mp_class.connect_ivf(0301009184);
        MySqlDataAdapter da5 = new MySqlDataAdapter("Select concat(uye_adi,' ',uye_soyadi) as ad,uye_id as ID from uye_doktor order by ad asc", connect_word);
        DataTable dt5 = new DataTable();
        da5.Fill(dt5);

        drpK.DataSource = dt5;
        drpK.DataTextField = dt5.Columns["ad"].ToString();
        drpK.DataValueField = dt5.Columns["ID"].ToString();
        drpK.DataBind();
        ...
        yeni.Text = "Tümü";
        yeni.Value = "";
        drpK.Items.Insert(0, yeni);

    }
    private void kaynakDYukle()
    {
        MySqlConnection connect_word = mp_class.connect_ivf(0301009184);
        MySqlDataAdapter da5 = new MySqlDataAdapter("Select * from kaynakdoktor order by adi asc", connect_word);
        DataTable dt5 = new DataTable();
        da5.Fill(dt5);

        drpD.DataSource = dt5;
        drpD.DataTextField = dt5.Columns["adi"].ToString();
        drpD.DataValueField = dt5.Columns["ID"].ToString();
        drpD.DataBind();
        ...
        yeni.Text = "Tümü";
        yeni.Value = "";
        drpD.Items.Insert(0, yeni);

    }
    private void kaynakSYukle()
    {
        MySqlConnection connect_word = mp_class.connect_ivf(0301009184);
        MySqlDataAdapter da5 = new MySqlDataAdapter("Select * from saglikCalisani order by adi asc", connect_word);
        DataTable dt5 = new DataTable();
        da5.Fill(dt5);

        drpS.DataSource = dt5;
        drpS.DataTextField = dt5.Columns["adi"].ToString();
        drpS.DataValueField = dt5.Columns["ID"].ToString();
        drpS.DataBind();
        ...
        yeni.Text = "Tümü";
        yeni.Value = "";
        drpS.Items.Insert(0, yeni);

    }


    private void kaynakMYukle()
    {
        MySqlConnection connect_word = mp_class.connect_ivf(0301009184);
        MySqlDataAdapter da5 = new MySqlDataAdapter("Select * from kaynak order by adi asc", connect_word);
        DataTable dt5 = new DataTable();
        da5.Fill(dt5);

        drpM.DataSource = dt5;
        drpM.DataTextField = dt5.Columns["adi"].ToString();
        drpM.DataValueField = dt5.Columns["ID"].ToString();
        drpM.DataBind();
    ...
    void dis_dr_yukle()
    {
        try
        {
           ...
           string sql = "Select uye_id,kisaAd from uye_doktor where disdoktor='+' and kisaAd <>'' order by kisaAd asc";



            MySqlConnection connect_word = mp_class.connect_ivf(0301009184);
            MySqlDataAdapter da6 = new MySqlDataAdapter(sql, connect_word);
            DataTable dt6 = new DataTable();
            da6.Fill(dt6);
    ...
    void siklusyukle31()
    {
        ...
        {
            sql = " Select S.siklus_id,concat(U.uye_adi,' ',U.uye_soyadi) as ad ,L.txt9  as yas , concat(S.siklus_ay,' ',S.siklus_yil) as Siklus ,SUBSTRING(K.alan3,7,4) as yil,SUBSTRING(K.alan3,4,2) as ay , str_to_date(K.alan3,'%d.%m.%Y %H:%i:%s') as OPU , K.Sat as SAT , K.tani1 as T1,K.tani2 as T2,K.tani3 as T3,K.tani4 as T4, K.tedavi_protokolu, K.gebelik as Ge,K.ovulasyon as Ov,K.abortus as Ab,K.cogul as Co,K.dogum as Do,K.hiperstimulasyon as Hi , K.biyokimyasal as Biy,K.alan3 as OPU  , L.txt50 as oosit ,L.txt69 as totalfertilize ,L.txt33 as kriyo , K.gebeliksayisi as gs,P.txt78 as protokol,P.txt79 as bat, P.txt80 as bit, P.txt81 as kat,P.deger as deger, S.siklus_id as SID,K.fkh as FKH,K.kriyoyapildimi as kry , U.uye_id as hID from         siklus_ana_tab S,labSonuc L,labProtokol as P,uye_hasta U,kisa_siklus K,atama as A,uye_doktor as D where L.siklusID=S.siklus_id and P.siklusID=S.siklus_id and U.uye_id = CAST(S.hasta_id as UNSIGNED) and K.siklus_id=S.siklus_id and A.siklusID=S.siklus_id and A.doktorID=D.uye_id and K.alan3 <>'' and str_to_date(K.alan3 ,'%d.%m.%Y') >= '" + baslangictarihi + "' and str_to_date(K.alan3 ,'%d.%m.%Y') <= '" + bitistarihi + "' and K.istatistik is null and  (P.txt78 <>'' or P.txt79 <>'' or P.txt80<>'' or P.txt81) order by str_to_date(K.alan3 ,'%d.%m.%Y %H:%i:%s') asc";
            sql2 = " Select S.siklus_id,concat(U.uye_adi,' ',U.uye_soyadi) as ad ,L.txt9 as yas , concat(S.siklus_ay,' ',S.siklus_yil) as Siklus ,SUBSTRING(K.alan3,7,4) as yil,SUBSTRING(K.alan3,4,2) as ay , str_to_date(K.alan3,'%d.%m.%Y %H:%i:%s') as OPU , K.Sat as SAT , K.tani1 as T1,K.tani2 as T2,K.tani3 as T3,K.tani4 as T4, K.tedavi_protokolu, K.gebelik as Ge,K.ovulasyon as Ov,K.abortus as Ab,K.cogul as Co,K.dogum as Do,K.hiperstimulasyon as Hi , K.biyokimyasal as Biy,K.alan3 as OPU  , L.txt50 as oosit ,L.txt69 as totalfertilize ,L.txt33 as kriyo , K.gebeliksayisi as gs,P.txt78 as protokol,P.txt79 as bat, P.txt80 as bit, P.txt81 as kat,P.deger as deger, S.siklus_id as SID,K.fkh as FKH,K.kriyoyapildimi as kry , U.uye_id as hID from         siklus_ana_tab S,labSonuc L,labProtokol as P,uye_hasta U,kisa_siklus K,atama as A,uye_doktor as D where L.siklusID=S.siklus_id and P.siklusID=S.siklus_id and U.uye_id = CAST(S.hasta_id as UNSIGNED) and K.siklus_id=S.siklus_id and A.siklusID=S.siklus_id and A.doktorID=D.uye_id and K.alan3 <>'' and str_to_date(K.alan3 ,'%d.%m.%Y') >= '" + baslangictarihi + "' and str_to_date(K.alan3 ,'%d.%m.%Y') <= '" + bitistarihi + "' and  K.istatistik is null and  (P.txt78 <>'' or P.txt79 <>'' or P.txt80<>'' or P.txt81) order by str_to_date(K.alan3 ,'%d.%m.%Y %H:%i:%s') asc";
        }
        if (txtkurum.SelectedIndex == 0 && txttedavituru.SelectedIndex == 0 && txttedaviprotokolu.SelectedIndex != 0)
        {
            sql = " Select S.siklus_id,concat(U.uye_adi,' ',U.uye_soyadi) as ad ,L.txt9  as yas , concat(S.siklus_ay,' ',S.siklus_yil) as Siklus ,SUBSTRING(K.alan3,7,4) as yil,SUBSTRING(K.alan3,4,2) as ay , str_to_date(K.alan3,'%d.%m.%Y %H:%i:%s') as OPU , K.Sat as SAT , K.tani1 as T1,K.tani2 as T2,K.tani3 as T3,K.tani4 as T4, K.tedavi_protokolu, K.gebelik as Ge,K.ovulasyon as Ov,K.abortus as Ab,K.cogul as Co,K.dogum as Do,K.hiperstimulasyon as Hi , K.biyokimyasal as Biy,K.alan3 as OPU  , L.txt50 as oosit ,L.txt69 as totalfertilize ,L.txt33 as kriyo , K.gebeliksayisi as gs,P.txt78 as protokol,P.txt79 as bat, P.txt80 as bit, P.txt81 as kat,P.deger as deger, S.siklus_id as SID,K.fkh as FKH,K.kriyoyapildimi as kry , U.uye_id as hID from         siklus_ana_tab S,labSonuc L,labProtokol as P,uye_hasta U,kisa_siklus K,atama as A,uye_doktor as D where L.siklusID=S.siklus_id and P.siklusID=S.siklus_id and U.uye_id = CAST(S.hasta_id as UNSIGNED) and K.siklus_id=S.siklus_id and A.siklusID=S.siklus_id and A.doktorID=D.uye_id and K.alan3 <>'' and str_to_date(K.alan3 ,'%d.%m.%Y') >= '" + baslangictarihi + "' and str_to_date(K.alan3 ,'%d.%m.%Y') <= '" + bitistarihi + "' and  K.tedavi_protokolu='" + txttedaviprotokolu.SelectedValue.ToString() + "' and K.istatistik is null and (P.txt78 <>'' or P.txt79 <>'' or P.txt80<>'' or P.txt81) order by str_to_date(K.alan3 ,'%d.%m.%Y %H:%i:%s') asc";
            sql2 = " Select S.siklus_id,concat(U.uye_adi,' ',U.uye_soyadi) as ad ,L.txt9  as yas , concat(S.siklus_ay,' ',S.siklus_yil) as Siklus ,SUBSTRING(K.alan3,7,4) as yil,SUBSTRING(K.alan3,4,2) as ay , str_to_date(K.alan3,'%d.%m.%Y %H:%i:%s') as OPU , K.Sat as SAT , K.tani1 as T1,K.tani2 as T2,K.tani3 as T3,K.tani4 as T4, K.tedavi_protokolu, K.gebelik as Ge,K.ovulasyon as Ov,K.abortus as Ab,K.cogul as Co,K.dogum as Do,K.hiperstimulasyon as Hi , K.biyokimyasal as Biy,K.alan3 as OPU , L.txt50 as oosit ,L.txt69 as totalfertilize ,L.txt33 as kriyo , K.gebeliksayisi as gs,P.txt78 as protokol,P.txt79 as bat, P.txt80 as bit, P.txt81 as kat,P.deger as deger, S.siklus_id as SID,K.fkh as FKH,K.kriyoyapildimi as kry, U.uye_id as hID  from         siklus_ana_tab S,labSonuc L,labProtokol as P,uye_hasta U,kisa_siklus K,atama as A,uye_doktor as D where L.siklusID=S.siklus_id and P.siklusID=S.siklus_id and U.uye_id = CAST(S.hasta_id as UNSIGNED) and K.siklus_id=S.siklus_id and A.siklusID=S.siklus_id and A.doktorID=D.uye_id and K.alan3 <>'' and str_to_date(K.alan3 ,'%d.%m.%Y') >= '" + baslangictarihi + "' and str_to_date(K.alan3 ,'%d.%m.%Y') <= '" + bitistarihi + "' and and   K.tedavi_protokolu='" + txttedaviprotokolu.SelectedValue.ToString() + "' and K.istatistik is null and (P.txt78 <>'' or P.txt79 <>'' or P.txt80<>'' or P.txt81) order by str_to_date(K.alan3 ,'%d.%m.%Y %H:%i:%s')  asc";
        }
        if (txtkurum.SelectedIndex == 0 && txttedavituru.SelectedIndex != 0 && txttedaviprotokolu.SelectedIndex == 0)
        {
            sql = " Select S.siklus_id,concat(U.uye_adi,' ',U.uye_soyadi) as ad ,L.txt9 as yas , concat(S.siklus_ay,' ',S.siklus_yil) as Siklus ,SUBSTRING(K.alan3,7,4) as yil,SUBSTRING(K.alan3,4,2) as ay , str_to_date(K.alan3,'%d.%m.%Y %H:%i:%s') as OPU , K.Sat as SAT , K.tani1 as T1,K.tani2 as T2,K.tani3 as T3,K.tani4 as T4, K.tedavi_protokolu, K.gebelik as Ge,K.ovulasyon as Ov,K.abortus as Ab,K.cogul as Co,K.dogum as Do,K.hiperstimulasyon as Hi , K.biyokimyasal as Biy,K.alan3 as OPU , L.txt50 as oosit ,L.txt69 as totalfertilize ,L.txt33 as kriyo , K.gebeliksayisi as gs,P.txt78 as protokol,P.txt79 as bat, P.txt80 as bit, P.txt81 as kat,P.deger as deger, S.siklus_id as SID,K.fkh as FKH,K.kriyoyapildimi as kry , U.uye_id as hID from        siklus_ana_tab S,labSonuc L,labProtokol as P,uye_hasta U,kisa_siklus K,atama as A,uye_doktor as D where L.siklusID=S.siklus_id and P.siklusID=S.siklus_id and U.uye_id = CAST(S.hasta_id as UNSIGNED) and K.siklus_id=S.siklus_id and A.siklusID=S.siklus_id and A.doktorID=D.uye_id and K.alan3 <>'' and str_to_date(K.alan3 ,'%d.%m.%Y') >= '" + baslangictarihi + "' and str_to_date(K.alan3 ,'%d.%m.%Y') <= '" + bitistarihi + "' and  K.tedavi_turu_id='" + txttedavituru.SelectedValue.ToString() + "' and K.istatistik is null and (P.txt78 <>'' or P.txt79 <>'' or P.txt80<>'' or P.txt81) order by str_to_date(K.alan3 ,'%d.%m.%Y %H:%i:%s')  asc";
        ...
        if (txtkurum.SelectedIndex != 0 && txttedavituru.SelectedIndex == 0 && txttedaviprotokolu.SelectedIndex == 0)
        {
            ...
            sql = " Select S.siklus_id,concat(U.uye_adi,' ',U.uye_soyadi) as ad ,L.txt9 as yas , concat(S.siklus_ay,' ',S.siklus_yil) as Siklus ,SUBSTRING(K.alan3,7,4) as yil,SUBSTRING(K.alan3,4,2) as ay , str_to_date(K.alan3,'%d.%m.%Y %H:%i:%s') as OPU , K.Sat as SAT , K.tani1 as T1,K.tani2 as T2,K.tani3 as T3,K.tani4 as T4, K.tedavi_protokolu, K.gebelik as Ge,K.ovulasyon as Ov,K.abortus as Ab,K.cogul as Co,K.dogum as Do,K.hiperstimulasyon as Hi , K.biyokimyasal as Biy,K.alan3 as OPU, L.txt50 as oosit ,L.txt69 as totalfertilize ,L.txt33 as kriyo , K.gebeliksayisi as gs,P.txt78 as protokol,P.txt79 as bat, P.txt80 as bit, P.txt81 as kat,P.deger as deger, S.siklus_id as SID,K.fkh as FKH,K.kriyoyapildimi as kry , U.uye_id as hID from siklus_ana_tab S,labSonuc L,labProtokol as P,uye_hasta U,kisa_siklus K,atama as A,uye_doktor as D where L.siklusID=S.siklus_id and P.siklusID=S.siklus_id and U.uye_id = CAST(S.hasta_id as UNSIGNED) and K.siklus_id=S.siklus_id and A.siklusID=S.siklus_id and A.doktorID=D.uye_id and K.alan3 <>'' and str_to_date(K.alan3 ,'%d.%m.%Y') >= '" + baslangictarihi + "' and str_to_date(K.alan3 ,'%d.%m.%Y') <= '" + bitistarihi + "' and K.kurum_id='" + txtkurum.SelectedValue.ToString() + "'  and K.istatistik is null and (P.txt78 <>'' or P.txt79 <>'' or P.txt80<>'' or P.txt81) order by str_to_date(K.alan3 ,'%d.%m.%Y %H:%i:%s')  asc";
            sql2 = " Select S.siklus_id,concat(U.uye_adi,' ',U.uye_soyadi) as ad ,L.txt9 as yas , concat(S.siklus_ay,' ',S.siklus_yil) as Siklus ,SUBSTRING(K.alan3,7,4) as yil,SUBSTRING(K.alan3,4,2) as ay , str_to_date(K.alan3,'%d.%m.%Y %H:%i:%s') as OPU , K.Sat as SAT , K.tani1 as T1,K.tani2 as T2,K.tani3 as T3,K.tani4 as T4, K.tedavi_protokolu, K.gebelik as Ge,K.ovulasyon as Ov,K.abortus as Ab,K.cogul as Co,K.dogum as Do,K.hiperstimulasyon as Hi , K.biyokimyasal as Biy,K.alan3 as OPU , L.txt50 as oosit ,L.txt69 as totalfertilize ,L.txt33 as kriyo , K.gebeliksayisi as gs,P.txt78 as protokol,P.txt79 as bat, P.txt80 as bit, P.txt81 as kat,P.deger as deger, S.siklus_id as SID,K.fkh as FKH,K.kriyoyapildimi as kry , U.uye_id as hID from siklus_ana_tab S,labSonuc L,labProtokol as P,uye_hasta U,kisa_siklus K,atama as A,uye_doktor as D where L.siklusID=S.siklus_id and P.siklusID=S.siklus_id and U.uye_id = CAST(S.hasta_id as UNSIGNED) and K.siklus_id=S.siklus_id and A.siklusID=S.siklus_id and A.doktorID=D.uye_id and K.alan3 <>'' and str_to_date(K.alan3 ,'%d.%m.%Y') >= '" + baslangictarihi + "' and str_to_date(K.alan3 ,'%d.%m.%Y') <= '" + bitistarihi + "' and  K.kurum_id='" + txtkurum.SelectedValue.ToString() + "'  and K.istatistik is null and (P.txt78 <>'' or P.txt79 <>'' or P.txt80<>'' or P.txt81) order by str_to_date(K.alan3 ,'%d.%m.%Y %H:%i:%s')  asc";


            // sql = " Select S.siklus_id,concat(U.uye_adi,' ',U.uye_soyadi) as ad ,L.txt9 as yas , concat(S.siklus_ay,' ',S.siklus_yil) as Siklus ,SUBSTRING(K.alan3,7,4) as yil,SUBSTRING(K.alan3,4,2) as ay , str_to_date(K.alan3,'%d.%m.%Y %H:%i:%s') as OPU , K.Sat as SAT , K.tani1 as T1,K.tani2 as T2,K.tani3 as T3,K.tani4 as T4, K.tedavi_protokolu, K.gebelik as Ge,K.ovulasyon as Ov,K.abortus as Ab,K.cogul as Co,K.dogum as Do,K.hiperstimulasyon as Hi , K.biyokimyasal as Biy,K.alan3 as OPU, L.txt50 as oosit ,L.txt69 as totalfertilize ,L.txt33 as kriyo , K.gebeliksayisi as gs,P.txt78 as protokol,P.txt79 as bat, P.txt80 as bit, P.txt81 as kat,P.deger as deger, S.siklus_id as SID,K.fkh as FKH,K.kriyoyapildimi as kry , U.uye_id as hID from siklus_ana_tab S LEFT JOIN labSonuc as L ON L.siklusID=S.siklus_id LEFT JOIN labProtokol as P ON P.siklusID=S.siklus_id LEFT JOIN uye_hasta U ON U.uye_id = CAST(S.hasta_id as UNSIGNED) LEFT JOIN kisa_siklus K ON K.siklus_id=S.siklus_id LEFT JOIN atama as A ON A.siklusID=S.siklus_id LEFT JOIN uye_doktor as D ON A.doktorID=D.uye_id where K.alan3 <>'' and str_to_date(K.alan3 ,'%d.%m.%Y') >= '" + baslangictarihi + "' and str_to_date(K.alan3 ,'%d.%m.%Y') <= '" + bitistarihi + "' and K.kurum_id='" + txtkurum.SelectedValue.ToString() + "'  and K.istatistik is null and (P.txt78 <>'' or P.txt79 <>'' or P.txt80<>'' or P.txt81) order by str_to_date(K.alan3 ,'%d.%m.%Y %H:%i:%s')  asc";
            //sql2 = " Select S.siklus_id,concat(U.uye_adi,' ',U.uye_soyadi) as ad ,L.txt9 as yas , concat(S.siklus_ay,' ',S.siklus_yil) as Siklus ,SUBSTRING(K.alan3,7,4) as yil,SUBSTRING(K.alan3,4,2) as ay , str_to_date(K.alan3,'%d.%m.%Y %H:%i:%s') as OPU , K.Sat as SAT , K.tani1 as T1,K.tani2 as T2,K.tani3 as T3,K.tani4 as T4, K.tedavi_protokolu, K.gebelik as Ge,K.ovulasyon as Ov,K.abortus as Ab,K.cogul as Co,K.dogum as Do,K.hiperstimulasyon as Hi , K.biyokimyasal as Biy,K.alan3 as OPU , L.txt50 as oosit ,L.txt69 as totalfertilize ,L.txt33 as kriyo , K.gebeliksayisi as gs,P.txt78 as protokol,P.txt79 as bat, P.txt80 as bit, P.txt81 as kat,P.deger as deger, S.siklus_id as SID,K.fkh as FKH,K.kriyoyapildimi as kry , U.uye_id as hID from siklus_ana_tab S LEFT JOIN labSonuc as L ON L.siklusID=S.siklus_id LEFT JOIN labProtokol as P ON P.siklusID=S.siklus_id LEFT JOIN uye_hasta U ON U.uye_id = CAST(S.hasta_id as UNSIGNED) LEFT JOIN kisa_siklus K ON K.siklus_id=S.siklus_id LEFT JOIN atama as A ON A.siklusID=S.siklus_id LEFT JOIN uye_doktor as D ON A.doktorID=D.uye_id where K.alan3 <>'' and str_to_date(K.alan3 ,'%d.%m.%Y') >= '" + baslangictarihi + "' and str_to_date(K.alan3 ,'%d.%m.%Y') <= '" + bitistarihi + "' and  K.kurum_id='" + txtkurum.SelectedValue.ToString() + "'  and K.istatistik is null and (P.txt78 <>'' or P.txt79 <>'' or P.txt80<>'' or P.txt81) order by str_to_date(K.alan3 ,'%d.%m.%Y %H:%i:%s')  asc";
        }
        if (txtkurum.SelectedIndex != 0 && txttedavituru.SelectedIndex != 0 && txttedaviprotokolu.SelectedIndex != 0)
        {
            sql = " Select S.siklus_id,concat(U.uye_adi,' ',U.uye_soyadi) as ad ,L.txt9 as yas , concat(S.siklus_ay,' ',S.siklus_yil) as Siklus ,SUBSTRING(K.alan3,7,4) as yil,SUBSTRING(K.alan3,4,2) as ay , str_to_date(K.alan3,'%d.%m.%Y %H:%i:%s') as OPU , K.Sat as SAT , K.tani1 as T1,K.tani2 as T2,K.tani3 as T3,K.tani4 as T4, K.tedavi_protokolu, K.gebelik as Ge,K.ovulasyon as Ov,K.abortus as Ab,K.cogul as Co,K.dogum as Do,K.hiperstimulasyon as Hi , K.biyokimyasal as Biy,K.alan3 as OPU , L.txt50 as oosit ,L.txt69 as totalfertilize ,L.txt33 as kriyo , K.gebeliksayisi as gs,P.txt78 as protokol,P.txt79 as bat, P.txt80 as bit, P.txt81 as kat,P.deger as deger, S.siklus_id as SID,K.fkh as FKH,K.kriyoyapildimi as kry , U.uye_id as hID from         siklus_ana_tab S,labSonuc L,labProtokol as P,uye_hasta U,kisa_siklus K,atama as A,uye_doktor as D where L.siklusID=S.siklus_id and P.siklusID=S.siklus_id and U.uye_id = CAST(S.hasta_id as UNSIGNED) and K.siklus_id=S.siklus_id and A.siklusID=S.siklus_id and A.doktorID=D.uye_id and K.alan3 <>'' and str_to_date(K.alan3 ,'%d.%m.%Y') >= '" + baslangictarihi + "' and str_to_date(K.alan3 ,'%d.%m.%Y') <= '" + bitistarihi + "' and  K.kurum_id='" + txtkurum.SelectedValue.ToString() + "' and K.tedavi_turu_id='" + txttedavituru.SelectedValue.ToString() + "' and K.tedavi_protokolu='" + txttedaviprotokolu.SelectedValue.ToString() + "' and K.istatistik is null and  (P.txt78 <>'' or P.txt79 <>'' or P.txt80<>'' or P.txt81) order by str_to_date(K.alan3 ,'%d.%m.%Y %H:%i:%s')  asc";
            sql2 = " Select S.siklus_id,concat(U.uye_adi,' ',U.uye_soyadi) as ad ,L.txt9 as yas , concat(S.siklus_ay,' ',S.siklus_yil) as Siklus ,SUBSTRING(K.alan3,7,4) as yil,SUBSTRING(K.alan3,4,2) as ay , str_to_date(K.alan3,'%d.%m.%Y %H:%i:%s') as OPU , K.Sat as SAT , K.tani1 as T1,K.tani2 as T2,K.tani3 as T3,K.tani4 as T4, K.tedavi_protokolu, K.gebelik as Ge,K.ovulasyon as Ov,K.abortus as Ab,K.cogul as Co,K.dogum as Do,K.hiperstimulasyon as Hi , K.biyokimyasal as Biy,K.alan3 as OPU , L.txt50 as oosit ,L.txt69 as totalfertilize ,L.txt33 as kriyo , K.gebeliksayisi as gs,P.txt78 as protokol,P.txt79 as bat, P.txt80 as bit, P.txt81 as kat,P.deger as deger, S.siklus_id as SID,K.fkh as FKH,K.kriyoyapildimi as kry , U.uye_id as hID from         siklus_ana_tab S,labSonuc L,labProtokol as P,uye_hasta U,kisa_siklus K,atama as A,uye_doktor as D where L.siklusID=S.siklus_id and P.siklusID=S.siklus_id and U.uye_id = CAST(S.hasta_id as UNSIGNED) and K.siklus_id=S.siklus_id and A.siklusID=S.siklus_id and A.doktorID=D.uye_id and K.alan3 <>'' and str_to_date(K.alan3 ,'%d.%m.%Y') >= '" + baslangictarihi + "' and str_to_date(K.alan3 ,'%d.%m.%Y') <= '" + bitistarihi + "' and K.kurum_id='" + txtkurum.SelectedValue.ToString() + "' and K.tedavi_turu_id='" + txttedavituru.SelectedValue.ToString() + "' and K.tedavi_protokolu='" + txttedaviprotokolu.SelectedValue.ToString() + "' and K.istatistik is null and (P.txt78 <>'' or P.txt79 <>'' or P.txt80<>'' or P.txt81) order by str_to_date(K.alan3 ,'%d.%m.%Y %H:%i:%s')  asc";
        }
        if (txtkurum.SelectedIndex != 0 && txttedavituru.SelectedIndex == 0 && txttedaviprotokolu.SelectedIndex != 0)
        {
            sql = " Select S.siklus_id,concat(U.uye_adi,' ',U.uye_soyadi) as ad ,L.txt9 as yas , concat(S.siklus_ay,' ',S.siklus_yil) as Siklus ,SUBSTRING(K.alan3,7,4) as yil,SUBSTRING(K.alan3,4,2) as ay , str_to_date(K.alan3,'%d.%m.%Y %H:%i:%s') as OPU , K.Sat as SAT , K.tani1 as T1,K.tani2 as T2,K.tani3 as T3,K.tani4 as T4, K.tedavi_protokolu, K.gebelik as Ge,K.ovulasyon as Ov,K.abortus as Ab,K.cogul as Co,K.dogum as Do,K.hiperstimulasyon as Hi , K.biyokimyasal as Biy,K.alan3 as OPU , L.txt50 as oosit ,L.txt69 as totalfertilize ,L.txt33 as kriyo , K.gebeliksayisi as gs,P.txt78 as protokol,P.txt79 as bat, P.txt80 as bit, P.txt81 as kat,P.deger as deger,S.siklus_id as SID,K.fkh as FKH,K.kriyoyapildimi as kry , U.uye_id as hID from         siklus_ana_tab S,labSonuc L,labProtokol as P,uye_hasta U,kisa_siklus K,atama as A,uye_doktor as D where L.siklusID=S.siklus_id and P.siklusID=S.siklus_id and U.uye_id = CAST(S.hasta_id as UNSIGNED) and K.siklus_id=S.siklus_id and A.siklusID=S.siklus_id and A.doktorID=D.uye_id and K.alan3 <>'' and str_to_date(K.alan3 ,'%d.%m.%Y') >= '" + baslangictarihi + "' and str_to_date(K.alan3 ,'%d.%m.%Y') <= '" + bitistarihi + "' and  K.kurum_id='" + txtkurum.SelectedValue.ToString() + "' and K.tedavi_protokolu='" + txttedaviprotokolu.SelectedValue.ToString() + "' and K.istatistik is null and (P.txt78 <>'' or P.txt79 <>'' or P.txt80<>'' or P.txt81) order by str_to_date(K.alan3 ,'%d.%m.%Y %H:%i:%s')  asc";
            sql2 = " Select S.siklus_id,concat(U.uye_adi,' ',U.uye_soyadi) as ad ,L.txt9 as yas , concat(S.siklus_ay,' ',S.siklus_yil) as Siklus ,SUBSTRING(K.alan3,7,4) as yil,SUBSTRING(K.alan3,4,2) as ay ,str_to_date(K.alan3,'%d.%m.%Y %H:%i:%s') as OPU ,  K.Sat as SAT , K.tani1 as T1,K.tani2 as T2,K.tani3 as T3,K.tani4 as T4, K.tedavi_protokolu, K.gebelik as Ge,K.ovulasyon as Ov,K.abortus as Ab,K.cogul as Co,K.dogum as Do,K.hiperstimulasyon as Hi , K.biyokimyasal as Biy,K.alan3 as OPU , L.txt50 as oosit ,L.txt69 as totalfertilize ,L.txt33 as kriyo , K.gebeliksayisi as gs,P.txt78 as protokol,P.txt79 as bat, P.txt80 as bit, P.txt81 as kat,P.deger as deger, S.siklus_id as SID,K.fkh as FKH,K.kriyoyapildimi as kry , U.uye_id as hID from         siklus_ana_tab S,labSonuc L,labProtokol as P,uye_hasta U,kisa_siklus K,atama as A,uye_doktor as D where L.siklusID=S.siklus_id and P.siklusID=S.siklus_id and U.uye_id = CAST(S.hasta_id as UNSIGNED) and K.siklus_id=S.siklus_id and A.siklusID=S.siklus_id and A.doktorID=D.uye_id and K.alan3 <>'' and str_to_date(K.alan3 ,'%d.%m.%Y') >= '" + baslangictarihi + "' and str_to_date(K.alan3 ,'%d.%m.%Y') <= '" + bitistarihi + "' and  K.kurum_id='" + txtkurum.SelectedValue.ToString() + "' and K.tedavi_protokolu='" + txttedaviprotokolu.SelectedValue.ToString() + "' and K.istatistik is null and (P.txt78 <>'' or P.txt79 <>'' or P.txt80<>'' or P.txt81) order by str_to_date(K.alan3 ,'%d.%m.%Y %H:%i:%s')  asc";
        }
        if (txtkurum.SelectedIndex != 0 && txttedavituru.SelectedIndex != 0 && txttedaviprotokolu.SelectedIndex == 0)
        {
            sql = " Select S.siklus_id,concat(U.uye_adi,' ',U.uye_soyadi) as ad ,L.txt9 as yas , concat(S.siklus_ay,' ',S.siklus_yil) as Siklus ,SUBSTRING(K.alan3,7,4) as yil,SUBSTRING(K.alan3,4,2) as ay , str_to_date(K.alan3,'%d.%m.%Y %H:%i:%s') as OPU , K.Sat as SAT , K.tani1 as T1,K.tani2 as T2,K.tani3 as T3,K.tani4 as T4, K.tedavi_protokolu, K.gebelik as Ge,K.ovulasyon as Ov,K.abortus as Ab,K.cogul as Co,K.dogum as Do,K.hiperstimulasyon as Hi , K.biyokimyasal as Biy,K.alan3 as OPU ,  L.txt50 as oosit ,L.txt69 as totalfertilize ,L.txt33 as kriyo , K.gebeliksayisi as gs,P.txt78 as protokol,P.txt79 as bat, P.txt80 as bit, P.txt81 as kat,P.deger as deger, S.siklus_id as SID,K.fkh as FKH,K.kriyoyapildimi as kry , U.uye_id as hID from         siklus_ana_tab S,labSonuc L,labProtokol as P,uye_hasta U,kisa_siklus K,atama as A,uye_doktor as D where L.siklusID=S.siklus_id and P.siklusID=S.siklus_id and U.uye_id = CAST(S.hasta_id as UNSIGNED) and K.siklus_id=S.siklus_id and A.siklusID=S.siklus_id and A.doktorID=D.uye_id and K.alan3 <>'' and str_to_date(K.alan3 ,'%d.%m.%Y') >= '" + baslangictarihi + "' and str_to_date(K.alan3 ,'%d.%m.%Y') <= '" + bitistarihi + "' and  K.kurum_id='" + txtkurum.SelectedValue.ToString() + "' and K.tedavi_turu_id='" + txttedavituru.SelectedValue.ToString() + "' and K.istatistik is null and (P.txt78 <>'' or P.txt79 <>'' or P.txt80<>'' or P.txt81) order by str_to_date(K.alan3 ,'%d.%m.%Y %H:%i:%s')  asc";
            sql2 = " Select S.siklus_id,concat(U.uye_adi,' ',U.uye_soyadi) as ad ,L.txt9 as yas , concat(S.siklus_ay,' ',S.siklus_yil) as Siklus ,SUBSTRING(K.alan3,7,4) as yil,SUBSTRING(K.alan3,4,2) as ay , str_to_date(K.alan3,'%d.%m.%Y %H:%i:%s') as OPU , K.Sat as SAT , K.tani1 as T1,K.tani2 as T2,K.tani3 as T3,K.tani4 as T4, K.tedavi_protokolu, K.gebelik as Ge,K.ovulasyon as Ov,K.abortus as Ab,K.cogul as Co,K.dogum as Do,K.hiperstimulasyon as Hi , K.biyokimyasal as Biy,K.alan3 as OPU , L.txt50 as oosit ,L.txt69 as totalfertilize ,L.txt33 as kriyo , K.gebeliksayisi as gs,P.txt78 as protokol,P.txt79 as bat, P.txt80 as bit, P.txt81 as kat,P.deger as deger,S.siklus_id as SID,K.fkh as FKH,K.kriyoyapildimi as kry , U.uye_id as hID from         siklus_ana_tab S,labSonuc L,labProtokol as P,uye_hasta U,kisa_siklus K,atama as A,uye_doktor as D where L.siklusID=S.siklus_id and P.siklusID=S.siklus_id and U.uye_id = CAST(S.hasta_id as UNSIGNED) and K.siklus_id=S.siklus_id and A.siklusID=S.siklus_id and A.doktorID=D.uye_id and K.alan3 <>'' and str_to_date(K.alan3 ,'%d.%m.%Y') >= '" + baslangictarihi + "' and str_to_date(K.alan3 ,'%d.%m.%Y') <= '" + bitistarihi + "' and  K.kurum_id='" + txtkurum.SelectedValue.ToString() + "' and K.tedavi_turu_id='" + txttedavituru.SelectedValue.ToString() + "' and K.istatistik is null and (P.txt78 <>'' or P.txt79 <>'' or P.txt80<>'' or P.txt81) order by str_to_date(K.alan3 ,'%d.%m.%Y %H:%i:%s')  asc";
        }
        if (txtkurum.SelectedIndex == 0 && txttedavituru.SelectedIndex != 0 && txttedaviprotokolu.SelectedIndex != 0)
        {
        ...
        //if (txtkurum.SelectedIndex == 0 && txttedavituru.SelectedIndex == 0 && txttedaviprotokolu.SelectedIndex == 0)
        //{
        //    sql = " Select S.siklus_id,concat(U.uye_adi,' ',U.uye_soyadi) as ad ,L.txt9  as yas , concat(S.siklus_ay,' ',S.siklus_yil) as Siklus ,SUBSTRING(K.alan3,7,4) as yil,SUBSTRING(K.alan3,4,2) as ay , str_to_date(K.alan3,'%d.%m.%Y %H:%i:%s') as OPU , K.Sat as SAT , K.tani1 as T1,K.tani2 as T2,K.tani3 as T3,K.tani4 as T4, K.tedavi_protokolu, K.gebelik as Ge,K.ovulasyon as Ov,K.abortus as Ab,K.cogul as Co,K.dogum as Do,K.hiperstimulasyon as Hi , K.biyokimyasal as Biy,K.alan3 as OPU  , L.txt50 as oosit ,L.txt69 as totalfertilize ,L.txt33 as kriyo , K.gebeliksayisi as gs,P.txt78 as protokol,P.txt79 as bat, P.txt80 as bit, P.txt81 as kat,P.deger as deger, S.siklus_id as SID,K.fkh as FKH,K.kriyoyapildimi as kry , U.uye_id as hID from siklus_ana_tab S LEFT JOIN labSonuc as L ON L.siklusID=S.siklus_id LEFT JOIN labProtokol as P ON P.siklusID=S.siklus_id LEFT JOIN uye_hasta U ON U.uye_id = CAST(S.hasta_id as UNSIGNED) LEFT JOIN kisa_siklus K ON K.siklus_id=S.siklus_id LEFT JOIN atama as A ON A.siklusID=S.siklus_id where K.alan3 <>'' and  K.istatistik is null and  (P.txt78 <>'' or P.txt79 <>'' or P.txt80<>'' or P.txt81) order by str_to_date(K.alan3 ,'%d.%m.%Y %H:%i:%s') asc";
        //    sql2 = " Select S.siklus_id,concat(U.uye_adi,' ',U.uye_soyadi) as ad ,L.txt9 as yas , concat(S.siklus_ay,' ',S.siklus_yil) as Siklus ,SUBSTRING(K.alan3,7,4) as yil,SUBSTRING(K.alan3,4,2) as ay , str_to_date(K.alan3,'%d.%m.%Y %H:%i:%s') as OPU , K.Sat as SAT , K.tani1 as T1,K.tani2 as T2,K.tani3 as T3,K.tani4 as T4, K.tedavi_protokolu, K.gebelik as Ge,K.ovulasyon as Ov,K.abortus as Ab,K.cogul as Co,K.dogum as Do,K.hiperstimulasyon as Hi , K.biyokimyasal as Biy,K.alan3 as OPU  , L.txt50 as oosit ,L.txt69 as totalfertilize ,L.txt33 as kriyo , K.gebeliksayisi as gs,P.txt78 as protokol,P.txt79 as bat, P.txt80 as bit, P.txt81 as kat,P.deger as deger, S.siklus_id as SID,K.fkh as FKH,K.kriyoyapildimi as kry , U.uye_id as hID from siklus_ana_tab S LEFT JOIN labSonuc as L ON L.siklusID=S.siklus_id LEFT JOIN labProtokol as P ON P.siklusID=S.siklus_id LEFT JOIN uye_hasta U ON U.uye_id = CAST(S.hasta_id as UNSIGNED) LEFT JOIN kisa_siklus K ON K.siklus_id=S.siklus_id LEFT JOIN atama as A ON A.siklusID=S.siklus_id where K.alan3 <>'' and  K.istatistik is null and  (P.txt78 <>'' or P.txt79 <>'' or P.txt80<>'' or P.txt81) order by str_to_date(K.alan3 ,'%d.%m.%Y %H:%i:%s') asc";
        //}
        //if (txtkurum.SelectedIndex == 0 && txttedavituru.SelectedIndex == 0 && txttedaviprotokolu.SelectedIndex != 0)
        //{
        //    sql = " Select S.siklus_id,concat(U.uye_adi,' ',U.uye_soyadi) as ad ,L.txt9  as yas , concat(S.siklus_ay,' ',S.siklus_yil) as Siklus ,SUBSTRING(K.alan3,7,4) as yil,SUBSTRING(K.alan3,4,2) as ay , str_to_date(K.alan3,'%d.%m.%Y %H:%i:%s') as OPU , K.Sat as SAT , K.tani1 as T1,K.tani2 as T2,K.tani3 as T3,K.tani4 as T4, K.tedavi_protokolu, K.gebelik as Ge,K.ovulasyon as Ov,K.abortus as Ab,K.cogul as Co,K.dogum as Do,K.hiperstimulasyon as Hi , K.biyokimyasal as Biy,K.alan3 as OPU  , L.txt50 as oosit ,L.txt69 as totalfertilize ,L.txt33 as kriyo , K.gebeliksayisi as gs,P.txt78 as protokol,P.txt79 as bat, P.txt80 as bit, P.txt81 as kat,P.deger as deger, S.siklus_id as SID,K.fkh as FKH,K.kriyoyapildimi as kry , U.uye_id as hID from siklus_ana_tab S LEFT JOIN labSonuc as L ON L.siklusID=S.siklus_id LEFT JOIN labProtokol as P ON P.siklusID=S.siklus_id LEFT JOIN uye_hasta U ON U.uye_id = CAST(S.hasta_id as UNSIGNED) LEFT JOIN kisa_siklus K ON K.siklus_id=S.siklus_id LEFT JOIN atama as A ON A.siklusID=S.siklus_id where K.alan3 <>'' and  K.tedavi_protokolu='" + txttedaviprotokolu.SelectedValue.ToString() + "' and K.istatistik is null and (P.txt78 <>'' or P.txt79 <>'' or P.txt80<>'' or P.txt81) order by str_to_date(K.alan3 ,'%d.%m.%Y %H:%i:%s') asc";
        //    sql2 = " Select S.siklus_id,concat(U.uye_adi,' ',U.uye_soyadi) as ad ,L.txt9  as yas , concat(S.siklus_ay,' ',S.siklus_yil) as Siklus ,SUBSTRING(K.alan3,7,4) as yil,SUBSTRING(K.alan3,4,2) as ay , str_to_date(K.alan3,'%d.%m.%Y %H:%i:%s') as OPU , K.Sat as SAT , K.tani1 as T1,K.tani2 as T2,K.tani3 as T3,K.tani4 as T4, K.tedavi_protokolu, K.gebelik as Ge,K.ovulasyon as Ov,K.abortus as Ab,K.cogul as Co,K.dogum as Do,K.hiperstimulasyon as Hi , K.biyokimyasal as Biy,K.alan3 as OPU , L.txt50 as oosit ,L.txt69 as totalfertilize ,L.txt33 as kriyo , K.gebeliksayisi as gs,P.txt78 as protokol,P.txt79 as bat, P.txt80 as bit, P.txt81 as kat,P.deger as deger, S.siklus_id as SID,K.fkh as FKH,K.kriyoyapildimi as kry, U.uye_id as hID  from siklus_ana_tab S LEFT JOIN labSonuc as L ON L.siklusID=S.siklus_id LEFT JOIN labProtokol as P ON P.siklusID=S.siklus_id LEFT JOIN uye_hasta U ON U.uye_id = CAST(S.hasta_id as UNSIGNED) LEFT JOIN kisa_siklus K ON K.siklus_id=S.siklus_id LEFT JOIN atama as A ON A.siklusID=S.siklus_id where K.alan3 <>'' and   K.tedavi_protokolu='" + txttedaviprotokolu.SelectedValue.ToString() + "' and K.istatistik is null and (P.txt78 <>'' or P.txt79 <>'' or P.txt80<>'' or P.txt81) order by str_to_date(K.alan3 ,'%d.%m.%Y %H:%i:%s')  asc";
        //}
        //if (txtkurum.SelectedIndex == 0 && txttedavituru.SelectedIndex != 0 && txttedaviprotokolu.SelectedIndex == 0)
        //{
        //    sql = " Select S.siklus_id,concat(U.uye_adi,' ',U.uye_soyadi) as ad ,L.txt9 as yas , concat(S.siklus_ay,' ',S.siklus_yil) as Siklus ,SUBSTRING(K.alan3,7,4) as yil,SUBSTRING(K.alan3,4,2) as ay , str_to_date(K.alan3,'%d.%m.%Y %H:%i:%s') as OPU , K.Sat as SAT , K.tani1 as T1,K.tani2 as T2,K.tani3 as T3,K.tani4 as T4, K.tedavi_protokolu, K.gebelik as Ge,K.ovulasyon as Ov,K.abortus as Ab,K.cogul as Co,K.dogum as Do,K.hiperstimulasyon as Hi , K.biyokimyasal as Biy,K.alan3 as OPU , L.txt50 as oosit ,L.txt69 as totalfertilize ,L.txt33 as kriyo , K.gebeliksayisi as gs,P.txt78 as protokol,P.txt79 as bat, P.txt80 as bit, P.txt81 as kat,P.deger as deger, S.siklus_id as SID,K.fkh as FKH,K.kriyoyapildimi as kry , U.uye_id as hID from siklus_ana_tab S LEFT JOIN labSonuc as L ON L.siklusID=S.siklus_id LEFT JOIN labProtokol as P ON P.siklusID=S.siklus_id LEFT JOIN uye_hasta U ON U.uye_id = CAST(S.hasta_id as UNSIGNED) LEFT JOIN kisa_siklus K ON K.siklus_id=S.siklus_id LEFT JOIN atama as A ON A.siklusID=S.siklus_id where K.alan3 <>'' and  K.tedavi_turu_id='" + txttedavituru.SelectedValue.ToString() + "' and K.istatistik is null and (P.txt78 <>'' or P.txt79 <>'' or P.txt80<>'' or P.txt81) order by str_to_date(K.alan3 ,'%d.%m.%Y %H:%i:%s')  asc";
        //    sql2 = " Select S.siklus_id,concat(U.uye_adi,' ',U.uye_soyadi) as ad ,L.txt9 as yas , concat(S.siklus_ay,' ',S.siklus_yil) as Siklus ,SUBSTRING(K.alan3,7,4) as yil,SUBSTRING(K.alan3,4,2) as ay , str_to_date(K.alan3,'%d.%m.%Y %H:%i:%s') as OPU , K.Sat as SAT , K.tani1 as T1,K.tani2 as T2,K.tani3 as T3,K.tani4 as T4, K.tedavi_protokolu, K.gebelik as Ge,K.ovulasyon as Ov,K.abortus as Ab,K.cogul as Co,K.dogum as Do,K.hiperstimulasyon as Hi , K.biyokimyasal as Biy,K.alan3 as OPU , L.txt50 as oosit ,L.txt69 as totalfertilize ,L.txt33 as kriyo , K.gebeliksayisi as gs,P.txt78 as protokol,P.txt79 as bat, P.txt80 as bit, P.txt81 as kat S.siklus_id as SID,K.fkh as FKH,K.kriyoyapildimi as kry , U.uye_id as hID from siklus_ana_tab S LEFT JOIN labSonuc as L ON L.siklusID=S.siklus_id LEFT JOIN labProtokol as P ON P.siklusID=S.siklus_id LEFT JOIN uye_hasta U ON U.uye_id = CAST(S.hasta_id as UNSIGNED) LEFT JOIN kisa_siklus K ON K.siklus_id=S.siklus_id LEFT JOIN atama as A ON A.siklusID=S.siklus_id where K.alan3 <>'' and  K.tedavi_turu_id='" + txttedavituru.SelectedValue.ToString() + "' and K.istatistik is null and (P.txt78 <>'' or P.txt79 <>'' or P.txt80<>'' or P.txt81) order by str_to_date(K.alan3 ,'%d.%m.%Y %H:%i:%s')  asc";
        //}
        ...
        //    sql = " Select S.siklus_id,concat(U.uye_adi,' ',U.uye_soyadi) as ad ,L.txt9 as yas , concat(S.siklus_ay,' ',S.siklus_yil) as Siklus ,SUBSTRING(K.alan3,7,4) as yil,SUBSTRING(K.alan3,4,2) as ay , str_to_date(K.alan3,'%d.%m.%Y %H:%i:%s') as OPU , K.Sat as SAT , K.tani1 as T1,K.tani2 as T2,K.tani3 as T3,K.tani4 as T4, K.tedavi_protokolu, K.gebelik as Ge,K.ovulasyon as Ov,K.abortus as Ab,K.cogul as Co,K.dogum as Do,K.hiperstimulasyon as Hi , K.biyokimyasal as Biy,K.alan3 as OPU, L.txt50 as oosit ,L.txt69 as totalfertilize ,L.txt33 as kriyo , K.gebeliksayisi as gs,P.txt78 as protokol,P.txt79 as bat, P.txt80 as bit, P.txt81 as kat,P.deger as deger, S.siklus_id as SID,K.fkh as FKH,K.kriyoyapildimi as kry , U.uye_id as hID from siklus_ana_tab S LEFT JOIN labSonuc as L ON L.siklusID=S.siklus_id LEFT JOIN labProtokol as P ON P.siklusID=S.siklus_id LEFT JOIN uye_hasta U ON U.uye_id = CAST(S.hasta_id as UNSIGNED) LEFT JOIN kisa_siklus K ON K.siklus_id=S.siklus_id LEFT JOIN atama as A ON A.siklusID=S.siklus_id where K.alan3 <>'' and  K.kurum_id='" + txtkurum.SelectedValue.ToString() + "'  and K.istatistik is null and (P.txt78 <>'' or P.txt79 <>'' or P.txt80<>'' or P.txt81) order by str_to_date(K.alan3 ,'%d.%m.%Y %H:%i:%s')  asc";
        //    sql2 = " Select S.siklus_id,concat(U.uye_adi,' ',U.uye_soyadi) as ad ,L.txt9 as yas , concat(S.siklus_ay,' ',S.siklus_yil) as Siklus ,SUBSTRING(K.alan3,7,4) as yil,SUBSTRING(K.alan3,4,2) as ay , str_to_date(K.alan3,'%d.%m.%Y %H:%i:%s') as OPU , K.Sat as SAT , K.tani1 as T1,K.tani2 as T2,K.tani3 as T3,K.tani4 as T4, K.tedavi_protokolu, K.gebelik as Ge,K.ovulasyon as Ov,K.abortus as Ab,K.cogul as Co,K.dogum as Do,K.hiperstimulasyon as Hi , K.biyokimyasal as Biy,K.alan3 as OPU , L.txt50 as oosit ,L.txt69 as totalfertilize ,L.txt33 as kriyo , K.gebeliksayisi as gs,P.txt78 as protokol,P.txt79 as bat, P.txt80 as bit, P.txt81 as kat,P.deger as deger, S.siklus_id as SID,K.fkh as FKH,K.kriyoyapildimi as kry , U.uye_id as hID from siklus_ana_tab S LEFT JOIN labSonuc as L ON L.siklusID=S.siklus_id LEFT JOIN labProtokol as P ON P.siklusID=S.siklus_id LEFT JOIN uye_hasta U ON U.uye_id = CAST(S.hasta_id as UNSIGNED) LEFT JOIN kisa_siklus K ON K.siklus_id=S.siklus_id LEFT JOIN atama as A ON A.siklusID=S.siklus_id where K.alan3 <>'' and  K.kurum_id='" + txtkurum.SelectedValue.ToString() + "'  and K.istatistik is null and (P.txt78 <>'' or P.txt79 <>'' or P.txt80<>'' or P.txt81) order by str_to_date(K.alan3 ,'%d.%m.%Y %H:%i:%s')  asc";
        //}
        //if (txtkurum.SelectedIndex != 0 && txttedavituru.SelectedIndex != 0 && txttedaviprotokolu.SelectedIndex != 0)
        //{
        //    sql = " Select S.siklus_id,concat(U.uye_adi,' ',U.uye_soyadi) as ad ,L.txt9 as yas , concat(S.siklus_ay,' ',S.siklus_yil) as Siklus ,SUBSTRING(K.alan3,7,4) as yil,SUBSTRING(K.alan3,4,2) as ay , str_to_date(K.alan3,'%d.%m.%Y %H:%i:%s') as OPU , K.Sat as SAT , K.tani1 as T1,K.tani2 as T2,K.tani3 as T3,K.tani4 as T4, K.tedavi_protokolu, K.gebelik as Ge,K.ovulasyon as Ov,K.abortus as Ab,K.cogul as Co,K.dogum as Do,K.hiperstimulasyon as Hi , K.biyokimyasal as Biy,K.alan3 as OPU , L.txt50 as oosit ,L.txt69 as totalfertilize ,L.txt33 as kriyo , K.gebeliksayisi as gs,P.txt78 as protokol,P.txt79 as bat, P.txt80 as bit, P.txt81 as kat,P.deger as deger, S.siklus_id as SID,K.fkh as FKH,K.kriyoyapildimi as kry , U.uye_id as hID from siklus_ana_tab S LEFT JOIN labSonuc as L ON L.siklusID=S.siklus_id LEFT JOIN labProtokol as P ON P.siklusID=S.siklus_id LEFT JOIN uye_hasta U ON U.uye_id = CAST(S.hasta_id as UNSIGNED) LEFT JOIN kisa_siklus K ON K.siklus_id=S.siklus_id LEFT JOIN atama as A ON A.siklusID=S.siklus_id where K.alan3 <>'' and  K.kurum_id='" + txtkurum.SelectedValue.ToString() + "' and K.tedavi_turu_id='" + txttedavituru.SelectedValue.ToString() + "' and K.tedavi_protokolu='" + txttedaviprotokolu.SelectedValue.ToString() + "' and K.istatistik is null and  (P.txt78 <>'' or P.txt79 <>'' or P.txt80<>'' or P.txt81) order by str_to_date(K.alan3 ,'%d.%m.%Y %H:%i:%s')  asc";
        //    sql2 = " Select S.siklus_id,concat(U.uye_adi,' ',U.uye_soyadi) as ad ,L.txt9 as yas , concat(S.siklus_ay,' ',S.siklus_yil) as Siklus ,SUBSTRING(K.alan3,7,4) as yil,SUBSTRING(K.alan3,4,2) as ay , str_to_date(K.alan3,'%d.%m.%Y %H:%i:%s') as OPU , K.Sat as SAT , K.tani1 as T1,K.tani2 as T2,K.tani3 as T3,K.tani4 as T4, K.tedavi_protokolu, K.gebelik as Ge,K.ovulasyon as Ov,K.abortus as Ab,K.cogul as Co,K.dogum as Do,K.hiperstimulasyon as Hi , K.biyokimyasal as Biy,K.alan3 as OPU , L.txt50 as oosit ,L.txt69 as totalfertilize ,L.txt33 as kriyo , K.gebeliksayisi as gs,P.txt78 as protokol,P.txt79 as bat, P.txt80 as bit, P.txt81 as kat,P.deger as deger, S.siklus_id as SID,K.fkh as FKH,K.kriyoyapildimi as kry , U.uye_id as hID from siklus_ana_tab S LEFT JOIN labSonuc as L ON L.siklusID=S.siklus_id LEFT JOIN labProtokol as P ON P.siklusID=S.siklus_id LEFT JOIN uye_hasta U ON U.uye_id = CAST(S.hasta_id as UNSIGNED) LEFT JOIN kisa_siklus K ON K.siklus_id=S.siklus_id LEFT JOIN atama as A ON A.siklusID=S.siklus_id where K.alan3 <>'' and  K.kurum_id='" + txtkurum.SelectedValue.ToString() + "' and K.tedavi_turu_id='" + txttedavituru.SelectedValue.ToString() + "' and K.tedavi_protokolu='" + txttedaviprotokolu.SelectedValue.ToString() + "' and K.istatistik is null and (P.txt78 <>'' or P.txt79 <>'' or P.txt80<>'' or P.txt81) order by str_to_date(K.alan3 ,'%d.%m.%Y %H:%i:%s')  asc";
        //}
        //if (txtkurum.SelectedIndex != 0 && txttedavituru.SelectedIndex == 0 && txttedaviprotokolu.SelectedIndex != 0)
        //{
        //    sql = " Select S.siklus_id,concat(U.uye_adi,' ',U.uye_soyadi) as ad ,L.txt9 as yas , concat(S.siklus_ay,' ',S.siklus_yil) as Siklus ,SUBSTRING(K.alan3,7,4) as yil,SUBSTRING(K.alan3,4,2) as ay , str_to_date(K.alan3,'%d.%m.%Y %H:%i:%s') as OPU , K.Sat as SAT , K.tani1 as T1,K.tani2 as T2,K.tani3 as T3,K.tani4 as T4, K.tedavi_protokolu, K.gebelik as Ge,K.ovulasyon as Ov,K.abortus as Ab,K.cogul as Co,K.dogum as Do,K.hiperstimulasyon as Hi , K.biyokimyasal as Biy,K.alan3 as OPU , L.txt50 as oosit ,L.txt69 as totalfertilize ,L.txt33 as kriyo , K.gebeliksayisi as gs,P.txt78 as protokol,P.txt79 as bat, P.txt80 as bit, P.txt81 as kat,P.deger as deger,S.siklus_id as SID,K.fkh as FKH,K.kriyoyapildimi as kry , U.uye_id as hID from siklus_ana_tab S LEFT JOIN labSonuc as L ON L.siklusID=S.siklus_id LEFT JOIN labProtokol as P ON P.siklusID=S.siklus_id LEFT JOIN uye_hasta U ON U.uye_id = CAST(S.hasta_id as UNSIGNED) LEFT JOIN kisa_siklus K ON K.siklus_id=S.siklus_id LEFT JOIN atama as A ON A.siklusID=S.siklus_id where K.alan3 <>'' and  K.kurum_id='" + txtkurum.SelectedValue.ToString() + "' and K.tedavi_protokolu='" + txttedaviprotokolu.SelectedValue.ToString() + "' and K.istatistik is null and (P.txt78 <>'' or P.txt79 <>'' or P.txt80<>'' or P.txt81) order by str_to_date(K.alan3 ,'%d.%m.%Y %H:%i:%s')  asc";
        //    sql2 = " Select S.siklus_id,concat(U.uye_adi,' ',U.uye_soyadi) as ad ,L.txt9 as yas , concat(S.siklus_ay,' ',S.siklus_yil) as Siklus ,SUBSTRING(K.alan3,7,4) as yil,SUBSTRING(K.alan3,4,2) as ay ,str_to_date(K.alan3,'%d.%m.%Y %H:%i:%s') as OPU ,  K.Sat as SAT , K.tani1 as T1,K.tani2 as T2,K.tani3 as T3,K.tani4 as T4, K.tedavi_protokolu, K.gebelik as Ge,K.ovulasyon as Ov,K.abortus as Ab,K.cogul as Co,K.dogum as Do,K.hiperstimulasyon as Hi , K.biyokimyasal as Biy,K.alan3 as OPU , L.txt50 as oosit ,L.txt69 as totalfertilize ,L.txt33 as kriyo , K.gebeliksayisi as gs,P.txt78 as protokol,P.txt79 as bat, P.txt80 as bit, P.txt81 as kat,P.deger as deger, S.siklus_id as SID,K.fkh as FKH,K.kriyoyapildimi as kry , U.uye_id as hID from siklus_ana_tab S LEFT JOIN labSonuc as L ON L.siklusID=S.siklus_id LEFT JOIN labProtokol as P ON P.siklusID=S.siklus_id LEFT JOIN uye_hasta U ON U.uye_id = CAST(S.hasta_id as UNSIGNED) LEFT JOIN kisa_siklus K ON K.siklus_id=S.siklus_id LEFT JOIN atama as A ON A.siklusID=S.siklus_id where K.alan3 <>'' and  K.kurum_id='" + txtkurum.SelectedValue.ToString() + "' and K.tedavi_protokolu='" + txttedaviprotokolu.SelectedValue.ToString() + "' and K.istatistik is null and (P.txt78 <>'' or P.txt79 <>'' or P.txt80<>'' or P.txt81) order by str_to_date(K.alan3 ,'%d.%m.%Y %H:%i:%s')  asc";
        //}
        //if (txtkurum.SelectedIndex != 0 && txttedavituru.SelectedIndex != 0 && txttedaviprotokolu.SelectedIndex == 0)
        //{
        //    sql = " Select S.siklus_id,concat(U.uye_adi,' ',U.uye_soyadi) as ad ,L.txt9 as yas , concat(S.siklus_ay,' ',S.siklus_yil) as Siklus ,SUBSTRING(K.alan3,7,4) as yil,SUBSTRING(K.alan3,4,2) as ay , str_to_date(K.alan3,'%d.%m.%Y %H:%i:%s') as OPU , K.Sat as SAT , K.tani1 as T1,K.tani2 as T2,K.tani3 as T3,K.tani4 as T4, K.tedavi_protokolu, K.gebelik as Ge,K.ovulasyon as Ov,K.abortus as Ab,K.cogul as Co,K.dogum as Do,K.hiperstimulasyon as Hi , K.biyokimyasal as Biy,K.alan3 as OPU ,  L.txt50 as oosit ,L.txt69 as totalfertilize ,L.txt33 as kriyo , K.gebeliksayisi as gs,P.txt78 as protokol,P.txt79 as bat, P.txt80 as bit, P.txt81 as kat,P.deger as deger, S.siklus_id as SID,K.fkh as FKH,K.kriyoyapildimi as kry , U.uye_id as hID from siklus_ana_tab S LEFT JOIN labSonuc as L ON L.siklusID=S.siklus_id LEFT JOIN labProtokol as P ON P.siklusID=S.siklus_id LEFT JOIN uye_hasta U ON U.uye_id = CAST(S.hasta_id as UNSIGNED) LEFT JOIN kisa_siklus K ON K.siklus_id=S.siklus_id LEFT JOIN atama as A ON A.siklusID=S.siklus_id where K.alan3 <>'' and  K.kurum_id='" + txtkurum.SelectedValue.ToString() + "' and K.tedavi_turu_id='" + txttedavituru.SelectedValue.ToString() + "' and K.istatistik is null and (P.txt78 <>'' or P.txt79 <>'' or P.txt80<>'' or P.txt81) order by str_to_date(K.alan3 ,'%d.%m.%Y %H:%i:%s')  asc";
        //    sql2 = " Select S.siklus_id,concat(U.uye_adi,' ',U.uye_soyadi) as ad ,L.txt9 as yas , concat(S.siklus_ay,' ',S.siklus_yil) as Siklus ,SUBSTRING(K.alan3,7,4) as yil,SUBSTRING(K.alan3,4,2) as ay , str_to_date(K.alan3,'%d.%m.%Y %H:%i:%s') as OPU , K.Sat as SAT , K.tani1 as T1,K.tani2 as T2,K.tani3 as T3,K.tani4 as T4, K.tedavi_protokolu, K.gebelik as Ge,K.ovulasyon as Ov,K.abortus as Ab,K.cogul as Co,K.dogum as Do,K.hiperstimulasyon as Hi , K.biyokimyasal as Biy,K.alan3 as OPU , L.txt50 as oosit ,L.txt69 as totalfertilize ,L.txt33 as kriyo , K.gebeliksayisi as gs,P.txt78 as protokol,P.txt79 as bat, P.txt80 as bit, P.txt81 as kat,P.deger as deger,S.siklus_id as SID,K.fkh as FKH,K.kriyoyapildimi as kry , U.uye_id as hID from siklus_ana_tab S LEFT JOIN labSonuc as L ON L.siklusID=S.siklus_id LEFT JOIN labProtokol as P ON P.siklusID=S.siklus_id LEFT JOIN uye_hasta U ON U.uye_id = CAST(S.hasta_id as UNSIGNED) LEFT JOIN kisa_siklus K ON K.siklus_id=S.siklus_id LEFT JOIN atama as A ON A.siklusID=S.siklus_id where K.alan3 <>'' and  K.kurum_id='" + txtkurum.SelectedValue.ToString() + "' and K.tedavi_turu_id='" + txttedavituru.SelectedValue.ToString() + "' and K.istatistik is null and (P.txt78 <>'' or P.txt79 <>'' or P.txt80<>'' or P.txt81) order by str_to_date(K.alan3 ,'%d.%m.%Y %H:%i:%s')  asc";
        //}
        //if (txtkurum.SelectedIndex == 0 && txttedavituru.SelectedIndex != 0 && txttedaviprotokolu.SelectedIndex != 0)
        //{
        ...
        if (kaynak.SelectedValue != "")
        {

            int sncm = sql.IndexOf("where");
            sql = sql.Insert(sncm, " LEFT JOIN iskaynak I ON I.hastaID=U.uye_id ");


            if (kaynak.SelectedValue == "H")
            {

                if (bilinmeyen.Checked == true)
                {

                    int sncm3 = sql.IndexOf("order");
                    sql = sql.Insert(sncm3, " and I.hasta='+' and I.bilinmeyenHasta='+' ");

                }
                else if (drpH.SelectedValue != "")
                {
                    int sncm3 = sql.IndexOf("order");
                    sql = sql.Insert(sncm3, " and I.hastaListesi='" + drpH.SelectedValue + "' ");
                }
                else
                {
                    int sncm3 = sql.IndexOf("order");
                    sql = sql.Insert(sncm3, " and I.hasta='+' ");
            ...
            if (kaynak.SelectedValue == "K")
            {

                if (drpK.SelectedValue != "")
                {
                    int sncm3 = sql.IndexOf("order");
                    sql = sql.Insert(sncm3, " and I.doktorListesi='" + drpK.SelectedValue + "' ");
                }
                else
                {
                    int sncm3 = sql.IndexOf("order");
                    sql = sql.Insert(sncm3, " and I.doktor='+' ");

                }

            }
            if (kaynak.SelectedValue == "D")
            {

                if (drpD.SelectedValue != "")
                {
                    int sncm3 = sql.IndexOf("order");
                    sql = sql.Insert(sncm3, " and I.baskaDoktorListesi='" + drpD.SelectedValue + "' ");
                }
                else
                {
                    int sncm3 = sql.IndexOf("order");
                    sql = sql.Insert(sncm3, " and I.baskaDoktor='+' ");
                }

            }

            if (kaynak.SelectedValue == "S")
            {

                if (drpS.SelectedValue != "")
                {
                    int sncm3 = sql.IndexOf("order");
                    sql = sql.Insert(sncm3, " and I.saglikCalisaniListesi='" + drpS.SelectedValue + "' ");

                }
                else
                {
                    int sncm3 = sql.IndexOf("order");
                    sql = sql.Insert(sncm3, " and I.saglikCalisani='+' ");

                }

            }
            if (kaynak.SelectedValue == "M")
            {

                if (drpM.SelectedValue != "")
                {
                    int sncm3 = sql.IndexOf("order");
                    sql = sql.Insert(sncm3, " and I.medyaListesi='" + drpM.SelectedValue + "' ");
                }
                else
                {
                    int sncm3 = sql.IndexOf("order");
                    sql = sql.Insert(sncm3, " and I.medya='+' ");
                }
        ...
        if (adres.Text != "")
        {
            ...
            int sncm3 = sql.IndexOf("order");
            sql = sql.Insert(sncm3, " and U.adres like '%"+adres.Text+"%' ");
        ...
        Panel pnlInfertilite = new Panel();
        ...
        if (suzgec.SelectedIndex == 0)
        {
            ...
            foreach (DataListItem str in list3.Items)
            {
                ...
                pnlInfertilite = (Panel)str.FindControl("pnlInfertilite");
                ...
                for (int c = 0; c < gebelikdt0.Rows.Count; c++)
                {
                    if (gebelikdt0.Rows[c]["deger"].ToString().TrimEnd().TrimStart() != "")
                    {
                        ...
                        degsay += int.Parse(gebelikdt0.Rows[c]["deger"].ToString());
                    }
                }
                ...
                foreach (GridViewRow satir in listehasta.Rows)
                {
                    ...
                    edt.OnClientClick = "window.open('mp55thumbivf.aspx?id=" + gebelikdt0.Rows[klm]["SID"].ToString() + "','','location=0,status=0,scrollbars=1,width=350,height=400');return false;";
                 ...
                 //   edt.CommandName = a.ToString() + "," + klm.ToString();
                    ...
                    adiSoyadi.OnClientClick = "createWindow('https://ivf2.ebebaba.com/ivfyonetici/hasta_modulu/th4820ft.aspx?ID=" + gebelikdt0.Rows[klm]["hID"].ToString() + "','" + gebelikdt0.Rows[klm]["ad"].ToString() + "','90%','530','');return false;";
    ...
    protected void save_Command(object sender, CommandEventArgs e)
    {
        ...
        if (siklusDr.SelectedIndex != 0)
        {
            ...
            MySqlCommand mp_cmd = new MySqlCommand("Update kisa_siklus set dr=?1 where siklus_id=?4", connect_word);
    ...
    void siklusyukle2()
    {
        ...
        if (drp_dis.SelectedIndex != 0)
        {
            ...
            //int sncm2 = sql.IndexOf("order");
            //sql = sql.Insert(sncm2, " and A.doktorID= '" + drp_dis.SelectedValue.ToString() + "' ");
        ...
        if (kaynak.SelectedValue != "")
        {
            ...
            int sncm = sql.IndexOf("where");
            sql = sql.Insert(sncm, ",iskaynak I ");


            int sncm2 = sql.IndexOf("U.uye_id");
            sql = sql.Insert(sncm2, " I.hastaID=U.uye_id and ");
        ...
        if (suzgec.SelectedIndex == 0)
        {
            ...
            foreach (DataListItem str in list.Items)
            {
                ...
                pnlOPU = (Panel)str.FindControl("pnlOPU");
                ...
                foreach (GridViewRow satir in listehasta.Rows)
                {
                    ...
                    edt.OnClientClick = "window.open('mp55thumbivf.aspx?id=" + gebelikdt4.Rows[klm]["SID"].ToString() + "','','location=0,status=0,scrollbars=1,width=350,height=400');return false;";
        ...
        else
        {
            ...
            foreach (DataListItem str in list.Items)
            {
                ...
                foreach (GridViewRow satir in listehasta.Rows)
                {
                    ...
                    //edt.CommandArgument = gebelikdt4.Rows[klm]["SID"].ToString();
                    edt.OnClientClick = "window.open('mp55thumbivf.aspx?id=" + gebelikdt4.Rows[klm]["SID"].ToString() + "','','location=1,status=0,scrollbars=1,width=350,height=400');return false;";
                    lbAd = (LinkButton)satir.FindControl("lbAd");
                    lbAd.Text = gebelikdt4.Rows[klm]["ad"].ToString();
                    //edt.CommandArgument = gebelikdt4.Rows[klm]["SID"].ToString();
                    edt.OnClientClick = "window.open('mp55thumbivf.aspx?id=" + gebelikdt4.Rows[klm]["SID"].ToString() + "','','location=0,status=0,scrollbars=1,width=350,height=400');return false;";
    ...
    void siklusyukleTum()
    {
        ...
        if (txtkurum.SelectedIndex == 0 && txttedavituru.SelectedIndex == 0 && txttedaviprotokolu.SelectedIndex != 0)
            sql = " Select S.siklus_id,concat(U.uye_adi,' ',U.uye_soyadi) as ad ,(year(str_to_date(S.siklus_eklenme_tarihi ,'%d.%m.%Y')) - year(str_to_date(U.uye_dogum_tarihi ,'%d.%m.%Y')))  as yas , concat(S.siklus_ay,' ',S.siklus_yil) as Siklus ,S.siklus_yil as yil,S.siklus_ay2 as ay , K.Sat as SAT ,  K.tedavi_protokolu, K.gebelik as Ge,K.ovulasyon as Ov,K.abortus as Ab,K.cogul as Co,K.dogum as Do,K.hiperstimulasyon as Hi , K.biyokimyasal as Biy,K.alan3 as OPU , K.alan4 as ET,S.siklus_id as SID,K.kriyoyapildimi as kry,K.dr as sDr,K.fkh as fkh   from siklus_ana_tab S,kisa_siklus K,uye_hasta U where U.uye_id = CAST(S.hasta_id as UNSIGNED) and K.siklus_id=S.siklus_id and K.tedavi_protokolu='" + txttedaviprotokolu.SelectedValue.ToString() + "' and K.istatistik is null order by concat(U.uye_adi,' ',U.uye_soyadi) asc";
...
Label label78 = new Label();
  ...
  Label label80 = new Label();
        ...
        GridView listehasta = new GridView();
        ImageButton ac0 = new ImageButton();
        ImageButton kapat0 = new ImageButton();

        Panel pnlTum = new Panel();

        if (suzgec.SelectedIndex == 0)
        {

            int a = 0;
            int toplamsiklussayisi = 0;

            foreach (DataListItem str in list4.Items)
            {


                pnlTum = (Panel)str.FindControl("pnlTum");
                label77 = (Label)str.FindControl("Label77");
                label77.Text = mp_class.ayadi(int.Parse(dttarih.Rows[a][0].ToString())) + " - " + dttarih.Rows[a][1].ToString();
                DataRow[] gebeliksatiri4 = mp_dt.Select("yil='" + dttarih.Rows[a][1].ToString() + "' and ay = '" + dttarih.Rows[a][0].ToString() + "'");
                ...
                listehasta = (GridView)str.FindControl("detay4");
                listehasta.DataSource = gebelikdt4;
                listehasta.DataBind();


                ImageButton edt0 = new ImageButton();
                LinkButton lbAd0 = new LinkButton();

                int klm = 0;

                foreach (GridViewRow satir in listehasta.Rows)
                {
                    edt0 = (ImageButton)satir.FindControl("edt0");
                    lbAd0 = (LinkButton)satir.FindControl("lbAd0");
                    lbAd0.Text = gebelikdt4.Rows[klm]["ad"].ToString();
                    edt0.OnClientClick = "window.open('mp55thumbivf.aspx?id=" + gebelikdt4.Rows[klm]["SID"].ToString() + "','','location=0,status=0,scrollbars=1,width=350,height=400');return false;";
                    lbAd0.CommandArgument = gebelikdt4.Rows[klm]["SID"].ToString();
                ...
                ac0 = (ImageButton)str.FindControl("ac0");
                kapat0 = (ImageButton)str.FindControl("kapat0");
                if (toplamsiklussayisi < 1)
                {
                    ac0.Visible = false;
                }
                ...
                if (k < 10)
                {
                    ...
                    ac0.OnClientClick = "ctl00_ContentPlaceHolder1_list4_ctl01_detay4";



                    string sozcuk1 = "document.getElementById('ctl00_ContentPlaceHolder1_list4_ctl0" + k + "_detay4').style.display='';document.getElementById('ctl00_ContentPlaceHolder1_list4_ctl0" + k + "_kapat0').style.display='';document.getElementById('ctl00_ContentPlaceHolder1_list4_ctl0" + k + "_ac0').style.display='none';return false;";
                    string sozcuk2 = "document.getElementById('ctl00_ContentPlaceHolder1_list4_ctl0" + k + "_detay4').style.display='none';document.getElementById('ctl00_ContentPlaceHolder1_list4_ctl0" + k + "_kapat0').style.display='none';document.getElementById('ctl00_ContentPlaceHolder1_list4_ctl0" + k + "_ac0').style.display='';return false;";


                    ac0.OnClientClick = sozcuk1;
                    kapat0.OnClientClick = sozcuk2;

                }
                else
                {
                    string sozcuk1 = "document.getElementById('ctl00_ContentPlaceHolder1_list4_ctl" + k + "_detay4').style.display='';document.getElementById('ctl00_ContentPlaceHolder1_list4_ctl" + k + "_kapat0').style.display='';document.getElementById('ctl00_ContentPlaceHolder1_list4_ctl" + k + "_ac0').style.display='none';return false;";
                    string sozcuk2 = "document.getElementById('ctl00_ContentPlaceHolder1_list4_ctl" + k + "_detay4').style.display='none';document.getElementById('ctl00_ContentPlaceHolder1_list4_ctl" + k + "_kapat0').style.display='none';document.getElementById('ctl00_ContentPlaceHolder1_list4_ctl" + k + "_ac0').style.display='';return false;";
                ...
                label80 = (Label)str.FindControl("Label80");
                label80.Text = "S : " + toplamsiklussayisi.ToString();


                if (toplamsiklussayisi == 0)
                {
                    pnlTum.Visible = false;
                }
        ...
        else
        {
            ...
            foreach (DataListItem str in list4.Items)
            {
                ...
                foreach (GridViewRow satir in listehasta.Rows)
                {
                    edt0 = (ImageButton)satir.FindControl("edt");
                    lbAd0 = (LinkButton)satir.FindControl("lbAd");
                    lbAd0.Text = gebelikdt4.Rows[klm]["ad"].ToString();
                    edt0.OnClientClick = "window.open('mp55thumbivf.aspx?id=" + gebelikdt4.Rows[klm]["SID"].ToString() + "','','location=0,status=0,scrollbars=1,width=350,height=400');return false;";
                    lbAd0.CommandArgument = gebelikdt4.Rows[klm]["SID"].ToString();
    ...
    protected void kaynak_SelectedIndexChanged(object sender, EventArgs e)
    {
        if (kaynak.SelectedValue == "H")
        {
            bilinmeyen.Visible = true;
            drpH.Visible = true;
            drpK.Visible = false;
            drpD.Visible = false;
            drpS.Visible = false;
        ...
        else if (kaynak.SelectedValue == "K")
        {
            bilinmeyen.Visible = false;
            drpH.Visible = false;
            drpK.Visible = true;
            drpD.Visible = false;
            drpS.Visible = false;
        ...
        else if (kaynak.SelectedValue == "D")
        {
            bilinmeyen.Visible = false;
            drpH.Visible = false;
            drpK.Visible = false;
        ...
        else if (kaynak.SelectedValue == "S")
        {
            bilinmeyen.Visible = false;
            drpH.Visible = false;
            drpK.Visible = false;
        ...
        else if (kaynak.SelectedValue == "M")
        {
            bilinmeyen.Visible = false;
            drpH.Visible = false;
            drpK.Visible = false;
    ...
    protected void bilinmeyen_CheckedChanged(object sender, EventArgs e)
    {
        if (bilinmeyen.Checked == true)
        {
            drpH.SelectedValue = "";
    ...
    protected void drpH_SelectedIndexChanged(object sender, EventArgs e)
    {
        if (drpH.SelectedValue != "")
        {

            bilinmeyen.Checked = false;
    ...
    void siklusyukle31Erkek()
    {
        ...
        sql = "Select UPPER(concat(U.uye_adi,' ',U.uye_soyadi)) as ad , U.uye_kayit_tarihi as KT, U.uye_dogum_tarihi as DT , year(str_to_date(U.uye_kayit_tarihi ,'%d.%m.%Y')) as yil, month(str_to_date(U.uye_kayit_tarihi ,'%d.%m.%Y')) as ay,U.uye_id as HID,P.txt78 as protokol,P.txt79 as bat, P.txt80 as bit, P.txt81 as kat,P.deger as deger from uye_hasta U LEFT JOIN labprotokolerkek P on U.uye_id=P.hastaID where U.erkek='+' order by concat(U.uye_adi,' ',U.uye_soyadi) asc";
        ...
        if (suzgec.SelectedIndex == 0)
        {
            ...
            foreach (DataListItem str in list5.Items)
            {

                pnlErkek = (Panel)str.FindControl("pnlErkek");
                label181 = (Label)str.FindControl("Label181");
                label181.Text = mp_class.ayadi(int.Parse(dttarih.Rows[a][0].ToString())) + " - " + dttarih.Rows[a][1].ToString();
                ...
                label185 = (Label)str.FindControl("Label185");
                if (protokolsay == 0)
                {
                    label185.Text = "-";
                }
                ...
                {
                    label185.Text = protokolsay.ToString();
                }
                label186 = (Label)str.FindControl("Label186");
                if (batsay == 0)
                {
                    label186.Text = "-";
                }
                ...
                {
                    label186.Text = batsay.ToString();
                }
                label187 = (Label)str.FindControl("Label187");
                if (bitsay == 0)
                {
                    label187.Text = "-";
                }
                ...
                {
                    label187.Text = bitsay.ToString();
                }

                label188 = (Label)str.FindControl("Label188");
                if (katsay == 0)
                {
                    label188.Text = "-";
                }
                ...
                {
                    label188.Text = katsay.ToString();
                }

                label189 = (Label)str.FindControl("Label189");
                if (degsay == 0)
                {
                    label189.Text = "-";
                }
                ...
                listehasta = (GridView)str.FindControl("detay5");
                ...
                RegularExpressionValidator rebat = new RegularExpressionValidator();
                RegularExpressionValidator rebit = new RegularExpressionValidator();
                RegularExpressionValidator rekat = new RegularExpressionValidator();
                RangeValidator redeg = new RangeValidator();
                ...
                foreach (GridViewRow satir in listehasta.Rows)
                {
                    ...
                    edt = (ImageButton)satir.FindControl("edt1");
                    save = (ImageButton)satir.FindControl("save0");
                    adiSoyadi = (LinkButton)satir.FindControl("adiSoyadi0");
                    calismaProtokolKodu = (Label)satir.FindControl("calismaProtokolKodu0");
                    baslamaTarihi = (Label)satir.FindControl("baslamaTarihi0");
                    bitisTarihi = (Label)satir.FindControl("bitisTarihi0");
                    kayitTarihi = (Label)satir.FindControl("kayitTarihi0");
                    deger = (Label)satir.FindControl("deger0");

                    hID = (Label)satir.FindControl("hID0");

                    txtCalismaProtokolKodu = (TextBox)satir.FindControl("txtCalismaProtokolKodu0");
                    txtBaslamaTarihi = (TextBox)satir.FindControl("txtBaslamaTarihi0");
                    txtBitisTarihi = (TextBox)satir.FindControl("txtBitisTarihi0");
                    txtKayitTarihi = (TextBox)satir.FindControl("txtKayitTarihi0");
                    txtDeger = (TextBox)satir.FindControl("txtDeger0");


                    rebat = (RegularExpressionValidator)satir.FindControl("rebat");
                    rebit = (RegularExpressionValidator)satir.FindControl("rebit");
                    rekat = (RegularExpressionValidator)satir.FindControl("rekat");
                    redeg = (RangeValidator)satir.FindControl("redeg");

                    rebat.ValidationGroup = a.ToString() + "erkek" + klm.ToString();
                    rebit.ValidationGroup = a.ToString() + "erkek" + klm.ToString();
                    rekat.ValidationGroup = a.ToString() + "erkek" + klm.ToString();
                    redeg.ValidationGroup = a.ToString() + "erkek" + klm.ToString();
                    save.ValidationGroup = a.ToString() + "erkek" + klm.ToString();


                    edt.CommandArgument = gebelikdt0.Rows[klm]["HID"].ToString();
                    edt.CommandName = a.ToString() + "," + klm.ToString();
                    adiSoyadi.Text = gebelikdt0.Rows[klm]["ad"].ToString();

                    adiSoyadi.OnClientClick = "createWindow('https://ivf2.ebebaba.com/ivfyonetici/hasta_modulu/th4820ft.aspx?ID=" + gebelikdt0.Rows[klm]["hID"].ToString() + "','" + gebelikdt0.Rows[klm]["ad"].ToString() + "','90%','530','');return false;";

                    //  adiSoyadi.CommandArgument = gebelikdt0.Rows[klm]["HID"].ToString();
                ...
                ac = (ImageButton)str.FindControl("ac1");
                kapat = (ImageButton)str.FindControl("kapat1");
                if (toplamsiklussayisi < 1)
                {
                    ac.Visible = false;
                }
                ...
                if (k < 10)
                {
                    ...
                    ac.OnClientClick = "ctl00_ContentPlaceHolder1_list5_ctl01_detay5";



                    string sozcuk1 = "document.getElementById('ctl00_ContentPlaceHolder1_list5_ctl0" + k + "_detay5').style.display='';document.getElementById('ctl00_ContentPlaceHolder1_list5_ctl0" + k + "_kapat').style.display='';document.getElementById('ctl00_ContentPlaceHolder1_list5_ctl0" + k + "_ac').style.display='none';return false;";
                    string sozcuk2 = "document.getElementById('ctl00_ContentPlaceHolder1_list5_ctl0" + k + "_detay5').style.display='none';document.getElementById('ctl00_ContentPlaceHolder1_list5_ctl0" + k + "_kapat').style.display='none';document.getElementById('ctl00_ContentPlaceHolder1_list5_ctl0" + k + "_ac').style.display='';return false;";
                ...
                {
                    string sozcuk1 = "document.getElementById('ctl00_ContentPlaceHolder1_list5_ctl" + k + "_detay5').style.display='';document.getElementById('ctl00_ContentPlaceHolder1_list5_ctl" + k + "_kapat').style.display='';document.getElementById('ctl00_ContentPlaceHolder1_list5_ctl" + k + "_ac').style.display='none';return false;";
                    string sozcuk2 = "document.getElementById('ctl00_ContentPlaceHolder1_list5_ctl" + k + "_detay5').style.display='none';document.getElementById('ctl00_ContentPlaceHolder1_list5_ctl" + k + "_kapat').style.display='none';document.getElementById('ctl00_ContentPlaceHolder1_list5_ctl" + k + "_ac').style.display='';return false;";
                ...
                label184 = (Label)str.FindControl("Label184");
                label184.Text = "E : " + toplamsiklussayisi.ToString();
                //+ " / H : " + toplamhastasayisih.ToString();

                if (toplamsiklussayisi == 0)
                {
                   pnlErkek.Visible = false;
                }



                label182 = (Label)str.FindControl("Label182");
                label182.Text = " - ";


                label183 = (Label)str.FindControl("Label183");


                for (int s = 0; s < list5.Items.Count; s++)
                {

                    if (((Label)list5.Items[s].FindControl("Label184")).Text == "E : 0")
                    {


                        list5.Items[s].CssClass = "gizle";
        ...
        else if (suzgec.SelectedIndex == 1)
        {
            ...
            foreach (DataListItem str in list5.Items)
            {
                ...
                pnlErkek = (Panel)str.FindControl("pnlErkek");
                label181 = (Label)str.FindControl("Label181");
                label181.Text = dttarih.Rows[a][1].ToString();
    ...
    protected void edt1_Command(object sender, CommandEventArgs e)
    {
        ...
        GridView yeni = new GridView();
        yeni = (GridView)list5.Items[a].FindControl("detay5");

        ((ImageButton)yeni.Rows[b].FindControl("save0")).Visible = true;
        ((ImageButton)yeni.Rows[b].FindControl("save0")).CommandArgument = e.CommandArgument.ToString();
        ((ImageButton)yeni.Rows[b].FindControl("save0")).CommandName = e.CommandName.ToString();


        ((ImageButton)yeni.Rows[b].FindControl("edt1")).Visible = false;
        ((Label)yeni.Rows[b].FindControl("calismaProtokolKodu0")).Visible = false;
        ((Label)yeni.Rows[b].FindControl("baslamaTarihi0")).Visible = false;
        ((Label)yeni.Rows[b].FindControl("bitisTarihi0")).Visible = false;
        ((Label)yeni.Rows[b].FindControl("kayitTarihi0")).Visible = false;
        ((Label)yeni.Rows[b].FindControl("deger0")).Visible = false;



        ((TextBox)yeni.Rows[b].FindControl("txtCalismaProtokolKodu0")).Visible = true;
        ((TextBox)yeni.Rows[b].FindControl("txtBaslamaTarihi0")).Visible = true;
        ((TextBox)yeni.Rows[b].FindControl("txtBitisTarihi0")).Visible = true;
        ((TextBox)yeni.Rows[b].FindControl("txtKayitTarihi0")).Visible = true;
        ((TextBox)yeni.Rows[b].FindControl("txtDeger0")).Visible = true;


        ((TextBox)yeni.Rows[b].FindControl("txtCalismaProtokolKodu0")).Text = ((Label)yeni.Rows[b].FindControl("calismaProtokolKodu0")).Text;
        ((TextBox)yeni.Rows[b].FindControl("txtBaslamaTarihi0")).Text = ((Label)yeni.Rows[b].FindControl("baslamaTarihi0")).Text;
        ((TextBox)yeni.Rows[b].FindControl("txtBitisTarihi0")).Text = ((Label)yeni.Rows[b].FindControl("bitisTarihi0")).Text;
        ((TextBox)yeni.Rows[b].FindControl("txtKayitTarihi0")).Text = ((Label)yeni.Rows[b].FindControl("kayitTarihi0")).Text;
        ((TextBox)yeni.Rows[b].FindControl("txtDeger0")).Text = ((Label)yeni.Rows[b].FindControl("deger0")).Text;



    }
    protected void save0_Command(object sender, CommandEventArgs e)
    {
        string[] satirlar = e.CommandName.ToString().Split(',');
        int a = int.Parse(satirlar[0]);
        int b = int.Parse(satirlar[1]);
        ...
        MySqlConnection mp_connection = mp_class.connect_ivf(0301009184);
        MySqlDataAdapter mp_da = new MySqlDataAdapter("Select * from labprotokolerkek where hastaID="+e.CommandArgument.ToString()+"", mp_connection);
        DataTable mp_dt = new DataTable();
        mp_da.Fill(mp_dt);

        if (mp_dt.Rows.Count > 0)
        {
            MySqlCommand cmd = new MySqlCommand("Update labProtokolerkek set txt78=?1,txt79=?2,txt80=?3,txt81=?4,deger=?6 where hastaID=?5", connect_word);

            cmd.Parameters.AddWithValue("?1", ((TextBox)yeni.Rows[b].FindControl("txtCalismaProtokolKodu0")).Text);
            cmd.Parameters.AddWithValue("?2", ((TextBox)yeni.Rows[b].FindControl("txtBaslamaTarihi0")).Text);
            cmd.Parameters.AddWithValue("?3", ((TextBox)yeni.Rows[b].FindControl("txtBitisTarihi0")).Text);
            cmd.Parameters.AddWithValue("?4", ((TextBox)yeni.Rows[b].FindControl("txtKayitTarihi0")).Text);
            cmd.Parameters.AddWithValue("?6", ((TextBox)yeni.Rows[b].FindControl("txtDeger0")).Text);
            cmd.Parameters.AddWithValue("?5", e.CommandArgument.ToString());
...

        {
            ...
            MySqlCommand cmd = new MySqlCommand("Insert labProtokolerkek(hastaID,txt78,txt79,txt80,txt81,deger) values (?5,?1,?2,?3,?4,?6)", connect_word);
        ...
        if (((Label)yeni.Rows[b].FindControl("calismaProtokolKodu0")).Text != ((TextBox)yeni.Rows[b].FindControl("txtCalismaProtokolKodu0")).Text)
        {
            logKayit = logKayit + "Ç.Protol Kodu:" + ((TextBox)yeni.Rows[b].FindControl("txtCalismaProtokolKodu0")).Text + " , ";
        }
        if (((Label)yeni.Rows[b].FindControl("baslamaTarihi0")).Text != ((TextBox)yeni.Rows[b].FindControl("txtBaslamaTarihi0")).Text)
        {
            logKayit = logKayit + "Baþ. Tarihi:" + ((TextBox)yeni.Rows[b].FindControl("txtBaslamaTarihi0")).Text + " , ";
        }
        if (((Label)yeni.Rows[b].FindControl("bitisTarihi0")).Text != ((TextBox)yeni.Rows[b].FindControl("txtBitisTarihi0")).Text)
        {
            logKayit = logKayit + "Bit. Tarihi:" + ((TextBox)yeni.Rows[b].FindControl("txtBitisTarihi0")).Text + " , ";
        }
        if (((Label)yeni.Rows[b].FindControl("kayitTarihi0")).Text != ((TextBox)yeni.Rows[b].FindControl("txtKayitTarihi0")).Text)
        {
            logKayit = logKayit + "Kayýt Tarihi:" + ((TextBox)yeni.Rows[b].FindControl("txtKayitTarihi0")).Text + " , ";
        }
        if (((Label)yeni.Rows[b].FindControl("deger0")).Text != ((TextBox)yeni.Rows[b].FindControl("txtDeger0")).Text)
        {
            logKayit = logKayit + "Deðer:" + ((TextBox)yeni.Rows[b].FindControl("txtDeger0")).Text + " , ";
        }


        if (logKayit == "")
        {
            logKayit = ((LinkButton)yeni.Rows[b].FindControl("adiSoyadi0")).Text + " Deðiþiklik yapmadan olduðu gibi güncellendi. (Lokasyon: Çalýþma Takibi Erkek)";
        }
        else
        {
            int son = logKayit.LastIndexOf(',');
            string bol = logKayit.Substring(0, son);
            logKayit = ((LinkButton)yeni.Rows[b].FindControl("adiSoyadi0")).Text + " " + bol + " olarak deðiþtirildi. (Lokasyon: Çalýþma Takibi Erkek)";
