...
(function ($) {
    ...
    */
    ...
    $.getJSON("https://api.rss2json.com/v1/api.json?rss_url=" + encodeURIComponent(reqURL) + channelID, function (data) {
        ...
        $("#ytvideo1").attr("src", "https://youtube.com/embed/" + id + "?controls=1&showinfo=1&rel=0");
        $("#yt1").attr("href", "https://youtube.com/watch?v=" + id);
        $("#yt1").attr("target", "_blank");

        var title = data.items[0].title.split('|');
        $("#ytTitle1").html(title[1]);

        var link1 = data.items[1].link;
        var id1 = link1.substr(link1.indexOf("=") + 1);
        $("#ytvideo2").attr("src", "https://youtube.com/embed/" + id1 + "?controls=0&showinfo=1&rel=0");
        $("#yt2").attr("href", "https://youtube.com/watch?v=" + id1);
        $("#yt2").attr("target", "_blank");

        var title2 = data.items[1].title.split('|');
        $("#ytTitle2").html(title2[1]);


        var link2 = data.items[2].link;
        var id2 = link2.substr(link2.indexOf("=") + 1);
        $("#ytvideo3").attr("src", "https://youtube.com/embed/" + id2 + "?controls=0&showinfo=1&rel=0");
        $("#yt3").attr("href", "https://youtube.com/watch?v=" + id2);
        $("#yt3").attr("target", "_blank");

        var title3 = data.items[2].title.split('|');
        $("#ytTitle3").html(title3[1]);
