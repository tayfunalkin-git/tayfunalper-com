...
public partial class makaleGoruntule : System.Web.UI.Page
{
    ...
    void konu_yukle()
    {
        try
        {
            ...
            //MySqlConnection connect_word = ebebaba_class.connect_ebebaba(0301009184);
            MySqlDataAdapter da_kitap = new MySqlDataAdapter("Select * from hosgeldiniz where link='" + Request.QueryString["ID"].ToString() + "' and neIseYarar='+' and yayin='+'", connectABO);
            ...
            if (dt_kitap.Rows.Count != 0)
            {
                ...
                MySqlDataAdapter da_kitapSonraki = new MySqlDataAdapter("Select * from hosgeldiniz where neIseYarar='+' and yayin='+' and sira>" + mSira + " order by sira asc limit 0,1", connectABO);
                ...
                if (dt_kitapSonraki.Rows.Count > 0)
                {
                    ...
                    sLink = "neIseYarar-" + dt_kitapSonraki.Rows[0]["link"].ToString() + ".aspx";
                }

                MySqlDataAdapter da_kitapOnceki = new MySqlDataAdapter("Select * from hosgeldiniz where neIseYarar='+' and yayin='+' and sira<" + mSira + " order by sira desc limit 0,1", connectABO);
                ...
                if (dt_kitapOnceki.Rows.Count > 0)
                {
                    ...
                    oLink = "neIseYarar-" + dt_kitapOnceki.Rows[0]["link"].ToString() + ".aspx";
                }
