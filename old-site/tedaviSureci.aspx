<%@ Language="C#" MasterPageFile="~/talper.master" AutoEventWireup="true" Debug="true" CodeFile="tedaviSureci.aspx.cs" Inherits="makaleGoruntule" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
        ...
        <div class="container">
            ...
            <ol class="breadcrumb">
               ...
               <li><a href="#">TÜP BEBEK TEDAVİ SÜRECİ</a></li>
			   <li><a href="#">TEDAVİ SÜRECİ</a></li>
            </ol>
