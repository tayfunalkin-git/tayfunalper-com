<%@ Language="C#" MasterPageFile="~/talper.master" AutoEventWireup="true" Debug="true" CodeFile="tedaviSonrasi.aspx.cs" Inherits="makaleGoruntule" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
        ...
        <div class="container">
            ...
            <ol class="breadcrumb">
               ...
               <li><a href="#">TÜP BEBEK TEDAVİ SONRASI</a></li>
			   <li><a href="#">TEDAVİ SONRASI</a></li>
            </ol>
