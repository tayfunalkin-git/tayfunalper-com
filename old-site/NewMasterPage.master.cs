...
public partial class NewMasterPage : System.Web.UI.MasterPage
{
    ...
    private void anaMenuYukle()
    {
        ...
        try
        {
            ...
            {
                eklenecek = "<div class='col'><h2><a href='../Default.aspx'>Anasayfa</a><br><br><a href='http://www.tayfunalper.com/makale.aspx?Bolum_ID=326&Konu_ID=533'>İletişim</a><br><br><a href='http://www.tayfunalper.com'>tayfunalper.com</a><br>2012 ©</h2></div>";
            }
    ...
    "</h2><ul>";
                    ...
                    {
                        liListe.InnerHtml = "<a href='http://www.tayfunalper.com/makale.aspx?Bolum_ID=326&Konu_ID=533' style='height:15px;line-height:15px;'>İletişim</a>";
                        liListe.Attributes.Add("class", "topmenu");
